      ...
      <div class="cia-ferias-card-container">
        ...
        >
          ...
          <template v-if="!invalidCode">
            ...
            <oxd-form-row class="cia-ferias-forgot-password-row">
            ...
            <oxd-divider />
            <div class="cia-ferias-forgot-password-buttons">
              <oxd-button
                :label="$t('general.save')"
                size="large"
                type="submit"
                display-type="secondary"
                class="cia-ferias-forgot-password-button"
              />
            </div>
          </template>
        </oxd-form>
...
import {promiseDebounce, OxdAlert} from '@cia-ferias/oxd';
