...
<template>
  <div class="cia-ferias-admin-access-container">
    <div class="cia-ferias-card-container">
      ...
      >
        <oxd-text tag="h6" class="cia-ferias-admin-access-title">
          {{ $t('auth.admin_access') }}
        </oxd-text>
        ...
        <div class="cia-ferias-admin-access-button-container">
          <oxd-button
            class="cia-ferias-admin-access-button"
            display-type="ghost"
            size="large"
...
export default {
  ...
  data() {
    return {
      ...
      noteClasses: {
        'cia-ferias-admin-access-note': true,
        '--padding': this.error === null,
      },
      noteContainerClass: {
        'cia-ferias-admin-access-note-container': this.error === null,
      },
    };
  },
