...
<template>
  <div>
    <oxd-text tag="p" class="cia-ferias-social-auth-header">
      {{ $t('general.or_login_with') }}
    </oxd-text>
  </div>
  <div class="cia-ferias-social-auth">
    <auth-button
...
import AuthButton from '@/ciaFeriasAuthenticationPlugin/components/AuthButton.vue';
