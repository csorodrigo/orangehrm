...
<template>
  <oxd-sheet :gutters="false" class="cia-ferias-directory-card">
    <div
      v-show="showBackButton"
      class="cia-ferias-directory-card-top"
    ...
    <div
      ...
      class="cia-ferias-directory-card-body"
    >
      <oxd-icon
        class="cia-ferias-directory-card-icon"
        name="geo-alt-fill"
      ></oxd-icon>
      <div>
        <oxd-text
...
<script>
import ProfilePicture from '@/ciaFeriasCorporateDirectoryPlugin/components/ProfilePicture';
import {OxdIcon, OxdSheet} from '@cia-ferias/oxd';
...
export default {
  ...
  computed: {
    ...
    cardTitleClasses() {
      return {
        'cia-ferias-directory-card-header': true,
        '--break-words': !this.hasDefaultSlot,
      };
    },
    cardSubTitleClasses() {
      return {
        'cia-ferias-directory-card-subtitle': true,
        '--break-words': !this.hasDefaultSlot,
      };
    },
    cardDescriptionClasses() {
      return {
        'cia-ferias-directory-card-description': true,
        '--break-words': !this.hasDefaultSlot,
      };
    },
  },
