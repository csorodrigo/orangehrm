...
<template>
  ...
  <div
    v-show="employeeWorkEmail || employeeWorkTelephone"
    class="cia-ferias-directory-card-rounded-body"
  >
    <div v-show="employeeWorkTelephone" class="cia-ferias-directory-card-icon">
      <oxd-icon-button
    ...
    <div v-show="employeeWorkEmail" class="cia-ferias-directory-card-icon">
      <oxd-icon-button
        display-type="danger"
        name="envelope-fill"
  ...
  <div
    ...
    class="cia-ferias-directory-card-hover"
    @mouseleave="showTelephoneClip = false"
    @mouseover="showTelephoneClip = true"
  >
    <div class="cia-ferias-directory-card-hover-body">
    ...
    <div
      class="cia-ferias-directory-card-hover-body cia-ferias-directory-card-hover-icon"
    >
      <oxd-icon-button
...
import QRCode from '@/ciaFeriasCorporateDirectoryPlugin/components/QRCode';
