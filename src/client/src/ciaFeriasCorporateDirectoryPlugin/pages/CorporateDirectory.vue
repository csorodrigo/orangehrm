...
<template>
  <div class="cia-ferias-background-container">
    ...
    <div class="cia-ferias-corporate-directory">
      <div class="cia-ferias-paper-container">
        ...
        <div class="cia-ferias-bottom-container"></div>
      </div>

      <div
        v-if="isEmployeeSelected && isMobile === false"
        class="cia-ferias-corporate-directory-sidebar"
      >
        <oxd-grid-item>
...
import useInfiniteScroll from '@cia-ferias/core/util/composable/useInfiniteScroll';
import EmployeeAutocomplete from '@/core/components/inputs/EmployeeAutocomplete';
import SummaryCard from '@/ciaFeriasCorporateDirectoryPlugin/components/SummaryCard';
import EmployeeDetails from '@/ciaFeriasCorporateDirectoryPlugin/components/EmployeeDetails';
import SummaryCardDetails from '@/ciaFeriasCorporateDirectoryPlugin/components/SummaryCardDetails';
import {OxdSpinner, useResponsive} from '@cia-ferias/oxd';
...
export default {
  ...
  computed: {
    ...
    oxdGridClasses() {
      return {
        'cia-ferias-container': true,
        'cia-ferias-container-min-display': this.isEmployeeSelected,
      };
    },
    colSize() {
