...
import PhotoViewer from '@/ciaFeriasBuzzPlugin/components/PhotoViewer';
import PostDetails from '@/ciaFeriasBuzzPlugin/components/PostDetails';
import PostActionsPill from '@/ciaFeriasBuzzPlugin/components/PostActionsPill';
...
export default {
  ...
  setup(props) {
    ...
    const layoutClasses = computed(() => ({
      'cia-ferias-photo-carousel': true,
