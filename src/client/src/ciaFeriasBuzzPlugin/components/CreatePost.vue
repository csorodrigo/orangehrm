...
<template>
  <oxd-sheet class="cia-ferias-buzz-create-post">
    <div class="cia-ferias-buzz-create-post-header">
      <profile-image :employee="employee"></profile-image>
      <div class="cia-ferias-buzz-create-post-header-text">
    ...
    <oxd-divider />
    <div class="cia-ferias-buzz-create-post-actions">
      <oxd-glass-button
        icon="cameraglass"
...
<script>
import {ref} from 'vue';
import {OxdBuzzPostInput, OxdGlassButton, OxdSheet} from '@cia-ferias/oxd';
import useToast from '@/core/util/composable/useToast';
import {APIService} from '@/core/util/services/api.service';
import {shouldNotExceedCharLength} from '@/core/util/validation/rules';
import ProfileImage from '@/ciaFeriasBuzzPlugin/components/ProfileImage';
import ShareVideoModal from '@/ciaFeriasBuzzPlugin/components/ShareVideoModal';
import SharePhotoModal from '@/ciaFeriasBuzzPlugin/components/SharePhotoModal';
