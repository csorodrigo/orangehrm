...
<template>
  ...
  >
    ...
    <oxd-form :loading="loading" @submit-valid="onSubmit">
      <div class="cia-ferias-buzz-post-modal-header">
        <profile-image :employee="employee"></profile-image>
        <div class="cia-ferias-buzz-post-modal-header-text">
          <slot name="header"></slot>
        </div>
      </div>
      <slot></slot>
      <oxd-form-actions class="cia-ferias-buzz-post-modal-actions">
        <oxd-button
          type="submit"
          :disabled="disabled"
