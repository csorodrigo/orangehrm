 ...
 */
 -->
<template>
  <div class="cia-ferias-buzz-pill">
    <div class="cia-ferias-buzz-pill-actions">
      <post-like :like="post.liked" @click="onClickLike"></post-like>
      <post-comment @click="onClickComment"></post-comment>
    </div>
    <div class="cia-ferias-buzz-pill-stats">
      <div class="cia-ferias-buzz-pill-stats-likes">
        <oxd-icon name="heart-fill"></oxd-icon>
        <oxd-text tag="p">
          {{ $t('buzz.n_like', {likesCount: post.stats.numOfLikes}) }}
        </oxd-text>
      </div>
      <div class="cia-ferias-buzz-pill-stats-other">
...
import PostCommentButton from '@/ciaFeriasBuzzPlugin/components/PostCommentButton';
