...
<template>
  <div class="cia-ferias-buzz-anniversary">
    <oxd-text type="card-title" class="cia-ferias-buzz-anniversary-title">
      {{ $t('buzz.upcoming_anniversaries') }}
    </oxd-text>
    <div
      class="cia-ferias-buzz-anniversary-content"
      :class="{'--show-more': anniversariesCount > 5}"
    >
      <div
        v-for="anniversary in anniversaries"
        :key="anniversary"
        class="cia-ferias-buzz-anniversary-item"
      >
        <div class="cia-ferias-buzz-anniversary-profile">
          <profile-image :employee="anniversary"></profile-image>
          <div class="cia-ferias-buzz-anniversary-profile-details">
            <oxd-text tag="p" class="cia-ferias-buzz-anniversary-emp-name">
              {{ anniversary.empName }}
            </oxd-text>
            <oxd-text tag="p" class="cia-ferias-buzz-anniversary-job-details">
              {{ anniversary.jobTitle }}
            </oxd-text>
          </div>
        </div>
        <div class="cia-ferias-buzz-anniversary-duration">
          <img
            alt="year celebration"
            class="cia-ferias-buzz-anniversary-year-celebration"
            :src="celebrationPic"
          />
          <div class="cia-ferias-buzz-anniversary-durations-text">
            <oxd-text
              tag="p"
              class="cia-ferias-buzz-anniversary-duration-years"
            >
            ...
            <oxd-text tag="p" class="cia-ferias-buzz-anniversary-duration-date">
              {{ anniversary.joinedDate }}
            </oxd-text>
          </div>
        </div>
      </div>
      <div v-if="isEmpty" class="cia-ferias-buzz-anniversary-nocontent">
    ...
    <div
      ...
      class="cia-ferias-buzz-anniversary-footer"
    >
