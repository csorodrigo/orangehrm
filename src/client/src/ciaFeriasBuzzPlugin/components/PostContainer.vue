...
<template>
  <oxd-sheet :gutters="false" type="white" class="cia-ferias-buzz">
    <div class="cia-ferias-buzz-post">
      <div class="cia-ferias-buzz-post-header">
        <div class="cia-ferias-buzz-post-header-details">
          <profile-image :employee="post.employee"></profile-image>
          <div class="cia-ferias-buzz-post-header-text">
            <oxd-text tag="p" class="cia-ferias-buzz-post-emp-name">
              {{ employeeFullName }}
            </oxd-text>
            <oxd-text tag="p" class="cia-ferias-buzz-post-time">
              {{ postDateTime }}
            </oxd-text>
          </div>
        </div>
        <div
          ...
          class="cia-ferias-buzz-post-header-config"
        >
          <oxd-dropdown>
            ...
            <template #content>
              <li
                ...
                class="cia-ferias-buzz-post-header-config-item"
    ...
    <div class="cia-ferias-buzz-post-footer">
...
import {OxdDropdownMenu, OxdIcon, OxdSheet} from '@cia-ferias/oxd';
