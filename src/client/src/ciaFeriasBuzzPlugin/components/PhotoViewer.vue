...
<template>
  <div class="cia-ferias-photo-viewer">
    <img
      class="cia-ferias-photo-viewer-background"
      alt="photo"
      :src="selectedPhoto"
    />
    <img
      class="cia-ferias-photo-viewer-photo"
      alt="background"
      :src="selectedPhoto"
    />
    <div
      v-if="post.photoIds.length > 1"
      class="cia-ferias-photo-viewer-controls"
    >
      <oxd-icon-button
        class="cia-ferias-photo-viewer-icon actions"
        name="chevron-left"
        :disabled="index === 0"
    ...
    <div class="cia-ferias-photo-viewer-actions">
      <slot></slot>
    </div>

    <oxd-icon-button
      class="cia-ferias-photo-viewer-close actions"
      name="x"
      @click="onClickClose"
    />
  </div>
