...
<template>
  <div class="cia-ferias-buzz-newsfeed">
    <oxd-text type="card-title" class="cia-ferias-buzz-newsfeed-title">
    ...
    <oxd-grid :cols="1" class="cia-ferias-buzz-newsfeed-posts">
      ...
      <oxd-grid-item
        ...
        class="cia-ferias-buzz-newsfeed-noposts"
      >
    ...
    <oxd-loading-spinner
      v-if="isLoading"
      class="cia-ferias-buzz-newsfeed-loader"
    />
  </div>
...
import PostBody from '@/ciaFeriasBuzzPlugin/components/PostBody.vue';
import PostStats from '@/ciaFeriasBuzzPlugin/components/PostStats.vue';
import CreatePost from '@/ciaFeriasBuzzPlugin/components/CreatePost.vue';
import useInfiniteScroll from '@/core/util/composable/useInfiniteScroll';
import PostActions from '@/ciaFeriasBuzzPlugin/components/PostActions.vue';
import useBuzzAPIs from '@/ciaFeriasBuzzPlugin/util/composable/useBuzzAPIs';
import EditPostModal from '@/ciaFeriasBuzzPlugin/components/EditPostModal.vue';
import PhotoCarousel from '@/ciaFeriasBuzzPlugin/components/PhotoCarousel.vue';
import PostContainer from '@/ciaFeriasBuzzPlugin/components/PostContainer.vue';
import SharePostModal from '@/ciaFeriasBuzzPlugin/components/SharePostModal.vue';
import DeleteConfirmationDialog from '@cia-ferias/components/dialogs/DeleteConfirmationDialog';
import PostCommentContainer from '@/ciaFeriasBuzzPlugin/components/PostCommentContainer.vue';
