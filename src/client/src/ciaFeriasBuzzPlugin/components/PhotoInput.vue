...
<template>
  <div class="cia-ferias-photo-input">
    <oxd-alert
      type="error"
    ...
    <photo-frame :media="modelValue">
      <template #content="{index}">
        <oxd-icon-button
          name="x"
          class="cia-ferias-photo-input-remove --float"
...
import PhotoUploadArea from '@/ciaFeriasBuzzPlugin/components/PhotoUploadArea';
