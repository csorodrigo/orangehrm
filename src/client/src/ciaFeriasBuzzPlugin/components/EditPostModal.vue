...
<template>
  ...
  >
    ...
    <template v-if="data.originalPost">
      ...
      <oxd-text tag="p" class="cia-ferias-buzz-share-employee">
        {{ originalPost.employee }}
      </oxd-text>
      <oxd-text tag="p" class="cia-ferias-buzz-share-date">
        {{ originalPost.dateTime }}
      </oxd-text>
      <oxd-text
        v-if="originalPost.text"
        tag="p"
        class="cia-ferias-buzz-share-text"
      >
        {{ originalPost.text }}
      </oxd-text>
    </template>
...
import PostModal from '@/ciaFeriasBuzzPlugin/components/PostModal';
...
import PhotoInput from '@/ciaFeriasBuzzPlugin/components/PhotoInput';
import useBuzzAPIs from '@/ciaFeriasBuzzPlugin/util/composable/useBuzzAPIs';
import useEmployeeNameTranslate from '@/core/util/composable/useEmployeeNameTranslate';
import {OxdBuzzPostInput, promiseDebounce} from '@cia-ferias/oxd';
