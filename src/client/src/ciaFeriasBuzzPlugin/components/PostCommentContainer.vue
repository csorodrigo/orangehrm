...
<template>
  <div class="cia-ferias-buzz-comment">
    <div class="cia-ferias-buzz-comment-add">
    ...
    <oxd-text
      v-if="total > 4"
      tag="p"
      class="cia-ferias-buzz-comment-readmore"
...
import PostComment from '@/ciaFeriasBuzzPlugin/components/PostComment';
