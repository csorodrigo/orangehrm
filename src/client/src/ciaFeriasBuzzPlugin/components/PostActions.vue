...
<template>
  <div class="cia-ferias-buzz-post-actions">
...
import PostLikeButton from '@/ciaFeriasBuzzPlugin/components/PostLikeButton.vue';
import PostShareButton from '@/ciaFeriasBuzzPlugin/components/PostShareButton.vue';
import PostCommentButton from '@/ciaFeriasBuzzPlugin/components/PostCommentButton.vue';
