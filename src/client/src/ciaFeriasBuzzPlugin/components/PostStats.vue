...
<template>
  <div v-click-outside="onClose" class="cia-ferias-buzz-stats">
    <div class="cia-ferias-buzz-stats-row">
      <oxd-icon
        name="heart-fill"
        class="cia-ferias-buzz-stats-like-icon"
      ></oxd-icon>
    ...
    <div class="cia-ferias-buzz-stats-row">
      <oxd-text
        tag="p"
        class="cia-ferias-buzz-stats-active"
...
<script>
import PostStatsModal from '@/ciaFeriasBuzzPlugin/components/PostStatsModal.vue';
import {clickOutsideDirective, OxdIcon} from '@cia-ferias/oxd';
...
export default {
  ...
  computed: {
    ...
    likesClasses() {
      return {
        'cia-ferias-buzz-stats-active': this.post.stats?.numOfLikes > 0,
      };
    },
    sharesClasses() {
      return {
        'cia-ferias-buzz-stats-active': this.post.stats?.numOfShares > 0,
      };
    },
  },
