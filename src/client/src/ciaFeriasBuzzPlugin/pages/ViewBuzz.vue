...
<template>
  ...
  <!-- Medium Res -->
  <oxd-grid v-else-if="width < 1920" :cols="2" class="cia-ferias-buzz-layout">
    <oxd-grid-item>
  ...
  <!-- High Res -->
  <oxd-grid v-else :cols="3" class="cia-ferias-buzz-layout">
    <oxd-grid-item>
      <post-filters
        :filter="sortField"
        @update-priority="onUpdatePriority"
...
import NewsFeed from '@/ciaFeriasBuzzPlugin/components/NewsFeed.vue';
import PostFilters from '@/ciaFeriasBuzzPlugin/components/PostFilters.vue';
import UpcomingAnniversaries from '@/ciaFeriasBuzzPlugin/components/UpcomingAnniversaries.vue';
