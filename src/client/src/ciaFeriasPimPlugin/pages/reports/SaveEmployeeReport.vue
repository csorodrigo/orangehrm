  ...
  <div class="cia-ferias-background-container">
    <div class="cia-ferias-card-container">
      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        ...
        <oxd-divider />
        <oxd-form-row>
          <oxd-text class="cia-ferias-sub-title" tag="h6">
            {{ $t('pim.selection_criteria') }}
          </oxd-text>
          <oxd-grid :cols="4" class="cia-ferias-full-width-grid">
            <oxd-grid-item class="cia-ferias-report-criteria --span-column-2">
              <oxd-input-field
...
import ReportCriterion from '@/ciaFeriasPimPlugin/components/ReportCriterion';
import ReportDisplayField from '@/ciaFeriasPimPlugin/components/ReportDisplayField';
import useEmployeeReport from '@/ciaFeriasPimPlugin/util/composable/useEmployeeReport';
