...
<template>
  <div class="cia-ferias-background-container">
    <div class="cia-ferias-card-container">
      ...
      <oxd-divider />
      <div class="cia-ferias-information-card-container">
        <oxd-text class="cia-ferias-sub-title">
          {{ $t('general.note') }}:
        </oxd-text>
        <ul>
          <li>
            <oxd-text class="cia-ferias-information-card-text">
...
import EmployeeDataImportModal from '@/ciaFeriasPimPlugin/components/EmployeeDataImportModal';
...
.cia-ferias-information-card-container {
  background-color: $oxd-interface-gray-lighten-2-color;
  border-radius: 1.2rem;
  padding: 1.2rem;
}
.cia-ferias-information-card-text {
