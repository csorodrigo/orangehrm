      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        <oxd-form-row>
          ...
          <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
            <div class="cia-ferias-optional-field-row">
              <oxd-text tag="p" class="cia-ferias-optional-field-label">
                {{
                  $t(
...
.cia-ferias-optional-field-label {
