...
import SaveSalaryComponent from '@/ciaFeriasPimPlugin/components/SaveSalaryComponent';
import EditSalaryComponent from '@/ciaFeriasPimPlugin/components/EditSalaryComponent';
