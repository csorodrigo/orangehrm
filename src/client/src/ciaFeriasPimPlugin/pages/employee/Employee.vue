    ...
    <div class="cia-ferias-paper-container">
      ...
      <div class="cia-ferias-container">
        <oxd-card-table
          ...
          :clickable="true"
          :loading="isLoading"
          class="cia-ferias-employee-list"
...
import SubunitDropdown from '@/ciaFeriasPimPlugin/components/SubunitDropdown';
import EmploymentStatusDropdown from '@/ciaFeriasPimPlugin/components/EmploymentStatusDropdown';
...
export default {
    ...
    const dataNormalizer = (data) => {
      return data.map((item) => {
        ...
        return {
          ...
          firstAndMiddleName: [item.firstName, item.middleName, item.lastName]
            .filter(Boolean)
            .join(' ')
            .concat(
  ...
  mounted() {
    document.body.classList.add('cia-ferias-pim-employee-list-page');
  },
  beforeUnmount() {
    document.body.classList.remove('cia-ferias-pim-employee-list-page');
  },
