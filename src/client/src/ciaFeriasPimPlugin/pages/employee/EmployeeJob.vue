...
<template>
  ...
  >
    ...
    <div
      ...
      class="cia-ferias-horizontal-padding cia-ferias-vertical-padding"
    >
      ...
      >
        ...
        <oxd-text
          ...
          tag="p"
          class="cia-ferias-terminate-date"
...
import EditEmployeeLayout from '@/ciaFeriasPimPlugin/components/EditEmployeeLayout';
import JobSpecDownload from '@/ciaFeriasPimPlugin/components/JobSpecDownload';
import ProfileActionHeader from '@/ciaFeriasPimPlugin/components/ProfileActionHeader';
import TerminateModal from '@/ciaFeriasPimPlugin/components/TerminateModal';
import {
  required,
  maxFileSize,
  validFileTypes,
