  ...
  <div class="cia-ferias-background-container">
    <div class="cia-ferias-card-container">
      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        <div class="cia-ferias-employee-container">
          <div class="cia-ferias-employee-image">
            <profile-image-input
          ...
          <div class="cia-ferias-employee-form">
            <oxd-form-row>
...
import ProfileImageInput from '@/ciaFeriasPimPlugin/components/ProfileImageInput';
