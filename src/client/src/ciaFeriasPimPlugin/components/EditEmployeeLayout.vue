...
<template>
  <div class="cia-ferias-background-container">
    <div class="cia-ferias-card-container">
      <div class="cia-ferias-edit-employee">
        <div class="cia-ferias-edit-employee-navigation">
          <div class="cia-ferias-edit-employee-imagesection">
            <div class="cia-ferias-edit-employee-name">
              <oxd-text tag="h6" class="--strong">{{ employeeName }}</oxd-text>
              <oxd-text v-if="!isCurrentEmp" type="subtitle-2">
                {{ $t('general.past_employee') }}
              </oxd-text>
            </div>
            <div class="cia-ferias-edit-employee-image-wrapper">
              <div
                class="cia-ferias-edit-employee-image"
        ...
        <div class="cia-ferias-edit-employee-content">
          <slot></slot>
...
import TabsNavigation from '@/ciaFeriasPimPlugin/components/TabsNavigation';
import ProfileAttachments from '@/ciaFeriasPimPlugin/components/ProfileAttachments';
import ProfileCustomFields from '@/ciaFeriasPimPlugin/components/ProfileCustomFields';
...
.cia-ferias-card-container {
  padding: unset;
}

.cia-ferias-edit-employee {
  display: flex;
