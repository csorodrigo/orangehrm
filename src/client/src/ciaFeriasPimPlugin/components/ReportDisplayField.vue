...
<template>
  <oxd-grid-item class="cia-ferias-report-field --offset-column-1">
    <oxd-icon-button name="trash-fill" @click="onClickDelete" />
    <oxd-text class="cia-ferias-report-field-name">
      {{ fieldGroup.label }}
    </oxd-text>
  </oxd-grid-item>
  ...
  <oxd-grid-item class="cia-ferias-report-field">
    <oxd-text class="cia-ferias-report-field-header" tag="p">
...
<script>
import {OxdSwitchInput, OxdMultiSelectChips} from '@cia-ferias/oxd';
