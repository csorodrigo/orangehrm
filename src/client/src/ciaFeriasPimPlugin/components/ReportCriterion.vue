...
<template>
  <oxd-grid-item class="cia-ferias-report-criteria --offset-column-1">
    <oxd-icon-button name="trash-fill" @click="onClickDelete" />
    <oxd-text class="cia-ferias-report-criteria-name">
      {{ criterion.label }}
    </oxd-text>
  </oxd-grid-item>
  <component
...
<script>
import {ref} from 'vue';
import ReportCriterionAutocomplete from '@/ciaFeriasPimPlugin/components/ReportCriterionAutocomplete';
import ReportCriterionSelect from '@/ciaFeriasPimPlugin/components/ReportCriterionSelect';
import ReportCriterionRange from '@/ciaFeriasPimPlugin/components/ReportCriterionRange';
import ReportCriterionDateRange from '@/ciaFeriasPimPlugin/components/ReportCriterionDateRange';
