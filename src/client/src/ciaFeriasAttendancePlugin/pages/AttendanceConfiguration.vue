      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        <oxd-form-row>
          <oxd-grid :cols="2" class="cia-ferias-full-width-grid">
            <div class="cia-ferias-attendance-field-row">
              <oxd-text tag="p" class="cia-ferias-attendance-field-label">
                {{
                  $t(
...
.cia-ferias-attendance-field-row {
  grid-column-start: 1;
  display: flex;
  justify-content: space-between;
  padding: 0.5rem 0.75rem;
}
.cia-ferias-attendance-field-label {
