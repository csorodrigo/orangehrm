...
<template>
  ...
  <div class="cia-ferias-paper-container">
    <div class="cia-ferias-header-container">
      <oxd-text class="cia-ferias-header-total" tag="span">
    ...
    <div class="cia-ferias-container">
      <oxd-card-table
        ...
        :clickable="false"
        :loading="isLoading"
        class="cia-ferias-my-attendance"
...
import RecordCell from '@/ciaFeriasAttendancePlugin/components/RecordCell.vue';
