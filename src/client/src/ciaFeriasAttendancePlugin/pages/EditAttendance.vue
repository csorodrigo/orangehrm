    ...
    <div class="cia-ferias-card-container">
      ...
      <div class="cia-ferias-paper-container">
        <oxd-form :loading="isLoading" @submit-valid="onSave">
          <oxd-grid :cols="2" class="cia-ferias-full-width-grid no-gap">
            <oxd-grid-item>
            ...
            <oxd-grid-item
              ...
              class="cia-ferias-punch-out-record"
            >
              <oxd-grid :cols="2" class="cia-ferias-full-width-grid">
                <oxd-grid-item>
                  <oxd-text type="subtitle-2">
...
import TimezoneDropdown from '@/ciaFeriasAttendancePlugin/components/TimezoneDropdown.vue';
