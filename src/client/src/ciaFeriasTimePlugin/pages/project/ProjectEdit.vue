        ...
        <oxd-grid :cols="2" class="cia-ferias-full-width-grid">
          ...
          <oxd-grid-item>
            ...
            <oxd-button
              ...
              icon-name="plus"
              display-type="text"
              class="cia-ferias-input-field-bottom-space"
...
import Activities from '@/ciaFeriasTimePlugin/components/Activities.vue';
import AddCustomerModal from '@/ciaFeriasTimePlugin/components/AddCustomerModal.vue';
