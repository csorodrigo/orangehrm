...
import CustomerAutocomplete from '@/ciaFeriasTimePlugin/components/CustomerAutocomplete.vue';
import ProjectAdminAutocomplete from '@/ciaFeriasTimePlugin/components/ProjectAdminAutocomplete.vue';
