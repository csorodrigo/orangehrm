...
<template>
  ...
  >
    ...
    <oxd-form :loading="isLoading" @submit-valid="onSave">
      <oxd-form-row>
        <oxd-grid :cols="2" class="cia-ferias-timesheet-grid">
          <oxd-text tag="p" class="cia-ferias-timesheet-title">
            {{ $t('time.project') }}:
          </oxd-text>
          <oxd-text tag="p" class="cia-ferias-timesheet-text">
            {{ projectName }}
          </oxd-text>
          <oxd-text tag="p" class="cia-ferias-timesheet-title">
            {{ $t('time.activity') }}:
...
<script>
import {shouldNotExceedCharLength} from '@cia-ferias/core/util/validation/rules';
