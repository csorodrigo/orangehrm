  ...
  <oxd-dialog class="cia-ferias-dialog-modal" @update:show="onCancel">
    ...
    <oxd-form :loading="isLoading" @submit-valid="onSave">
      ...
      <template v-if="activities && activities.length > 0">
        <oxd-divider />
        <oxd-grid :cols="2" class="cia-ferias-activites-container">
...
import {required, validSelection} from '@cia-ferias/core/util/validation/rules';
...
.cia-ferias-activites-container {
  max-height: 180px;
  overflow-y: auto;
