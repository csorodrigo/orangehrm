...
<template>
  <div class="cia-ferias-paper-container">
    <div class="cia-ferias-header-container">
      ...
      <div class="cia-ferias-main-actions">
        <oxd-button
...
import CopyActivityModal from '@/ciaFeriasTimePlugin/components/CopyActivityModal.vue';
import SaveActivityModal from '@/ciaFeriasTimePlugin/components/SaveActivityModal.vue';
import EditActivityModal from '@/ciaFeriasTimePlugin/components/EditActivityModal.vue';
