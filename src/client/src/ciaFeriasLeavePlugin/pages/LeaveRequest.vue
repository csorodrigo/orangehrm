...
<template>
  <div class="cia-ferias-background-container">
    <div class="cia-ferias-paper-container">
      ...
      <oxd-divider
        class="cia-ferias-horizontal-margin cia-ferias-clear-margins"
      />
      <br />
      <div class="cia-ferias-horizontal-padding">
        <oxd-grid :cols="3">
          <oxd-grid-item>
            <oxd-input-group :label="$t('general.employee_name')">
              <oxd-text class="cia-ferias-request-details-text" tag="p">
                {{ employeeName }}
              </oxd-text>
            </oxd-input-group>
          </oxd-grid-item>
...
.cia-ferias-bottom-container {
  align-items: center;
  justify-content: space-between;
}
.cia-ferias-request-details-text {
