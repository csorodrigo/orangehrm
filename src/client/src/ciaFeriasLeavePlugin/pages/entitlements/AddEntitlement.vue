      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        ...
        <oxd-form-row v-else>
          <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
            ...
            <oxd-grid-item class="cia-ferias-leave-entitled">
              <oxd-text
                class="cia-ferias-leave-entitled-text"
                type="subtitle-2"
              >
                {{
...
import LeavePeriodDropdown from '@/ciaFeriasLeavePlugin/components/LeavePeriodDropdown';
import EntitlementUpdateModal from '@/ciaFeriasLeavePlugin/components/EntitlementUpdateModal';
import EntitlementBulkUpdateModal from '@/ciaFeriasLeavePlugin/components/EntitlementBulkUpdateModal';
import EntitlementNoMatchModal from '@/ciaFeriasLeavePlugin/components/EntitlementNoMatchModal';
