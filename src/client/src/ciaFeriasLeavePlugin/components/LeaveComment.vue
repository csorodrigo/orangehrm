...
<template>
  <div class="cia-ferias-comment">
    <div class="cia-ferias-comment-profile">
      <div class="cia-ferias-comment-profile-image-wrapper">
        <img
          alt="profile picture"
          class="cia-ferias-comment-profile-image"
          :src="imgSrc"
        />
      </div>
    </div>
    <div class="cia-ferias-comment-body">
      <div class="cia-ferias-comment-profile-name">
        <oxd-text type="subtitle-2">
          {{ fullName }}
        </oxd-text>
      </div>
      <div class="cia-ferias-comment-message">
        <oxd-text type="subtitle-2">
          {{ data.comment }}
        </oxd-text>
      </div>
      <div class="cia-ferias-comment-timestamp">
        <oxd-text type="subtitle-2">
