  ...
  <template v-if="duration && duration.id === 4">
    ...
    <oxd-grid-item>
      <oxd-input-group :label="$t('general.duration')">
        <oxd-text class="cia-ferias-leave-duration" tag="p">
...
<script>
import {diffInTime} from '@cia-ferias/core/util/helper/datefns';
import {
  required,
  validTimeFormat,
...
import TimeRange from '@/ciaFeriasLeavePlugin/components/TimeRange';
