...
<template>
  <oxd-input-group>
    <template #label>
      <div class="cia-ferias-leave-balance">
    ...
    <oxd-text v-if="balance >= 0" class="cia-ferias-leave-balance-text" tag="p">
      {{ leaveBalance }}
    </oxd-text>
    <oxd-text v-else class="cia-ferias-leave-balance-text --error" tag="p">
...
import LeaveBalanceModal from '@/ciaFeriasLeavePlugin/components/LeaveBalanceModal';
import LeaveBalanceInsufficientModal from '@/ciaFeriasLeavePlugin/components/LeaveBalanceInsufficientModal';
import useLeaveValidators from '@/ciaFeriasLeavePlugin/util/composable/useLeaveValidators';
import {OxdLabel} from '@cia-ferias/oxd';
