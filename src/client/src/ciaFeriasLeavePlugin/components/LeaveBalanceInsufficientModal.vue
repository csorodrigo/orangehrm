...
<template>
  <oxd-dialog
    :gutters="false"
    class="cia-ferias-dialog-modal"
    @update:show="onCancel"
  >
    <div class="cia-ferias-dialog-header-container">
      <oxd-text tag="h6" class="cia-ferias-main-title">
        {{ $t('leave.insufficient_leave_balance') }}
      </oxd-text>
    </div>
    <oxd-divider
      class="cia-ferias-dialog-horizontal-margin cia-ferias-clear-margins"
    />
    <div
      class="cia-ferias-dialog-horizontal-padding cia-ferias-dialog-vertical-padding"
    >
      <oxd-grid :cols="3">
        <oxd-grid-item>
          <oxd-input-group :label="$t('general.employee_name')">
            <oxd-text class="cia-ferias-leave-balance-text" tag="p">
              {{ employeeName }}
            </oxd-text>
          </oxd-input-group>
        </oxd-grid-item>
    ...
    <div class="cia-ferias-container">
      <oxd-card-table
        ...
        :items="items"
        :clickable="false"
        class="cia-ferias-horizontal-padding"
