...
<template>
  <div
    :class="{
      'cia-ferias-action-button-container': allowedActions.length < 2,
      'cia-ferias-action-buttons-container': allowedActions.length > 1,
    }"
  >
    <oxd-button
      display-type="ghost"
      class="cia-ferias-sm-button"
...
.cia-ferias-action-buttons-container {
  display: flex;
  flex-direction: row;
  flex-wrap: wrap;
...
.cia-ferias-action-button-container {
  display: flex;
  flex-direction: row;
  flex-wrap: wrap;
  justify-content: flex-end;
