...
<template>
  <div class="cia-ferias-oauth-container">
    <div class="cia-ferias-card-container">
      <login-branding
        :img-src="loginBannerSrc"
        class="cia-ferias-oauth-branding"
      />
      <oxd-divider />
      <template v-if="errorType === null">
        ...
        <ul class="cia-ferias-oauth-list">
          <li>
        ...
        >
          ...
          <div class="cia-ferias-oauth-button-container">
            <oxd-button
              display-type="ghost"
              size="large"
              class="cia-ferias-oauth-button"
              :label="$t('auth.deny')"
              @click="onCancel"
            />
            <oxd-button
      ...
      <template v-else-if="params['client_id'] === 'cia_ferias_mobile_app'">
        <oxd-alert
          :show="true"
          type="error"
      ...
      <template v-else>
        ...
        />
        <oxd-text class="cia-ferias-oauth-error">
...
import LoginBranding from '@/ciaFeriasAuthenticationPlugin/components/LoginBranding.vue';
