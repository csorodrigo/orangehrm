...
<template>
  <base-widget
    ...
    class="cia-ferias-quick-launch-widget"
    :empty="isEmpty"
    :loading="isLoading"
    :title="$t('dashboard.quick_launch')"
  >
    <oxd-grid :cols="4" class="cia-ferias-quick-launch">
      <oxd-grid-item
        v-for="action in sortedActions"
        :key="action"
        class="cia-ferias-quick-launch-card"
      >
        <oxd-icon-button
          icon-type="svg"
          class="cia-ferias-quick-launch-icon"
          :name="action.icon"
          :title="action.label"
          @click="onClickAction(action.path)"
        />
        <div class="cia-ferias-quick-launch-heading" :title="action.label">
