...
<template>
  <base-widget
    ...
    class="cia-ferias-attendance-widget"
  >
    <div class="cia-ferias-attendance-card">
      <div class="cia-ferias-attendance-card-profile">
        <div class="cia-ferias-attendance-card-profile-image">
          <img
            alt="profile picture"
        ...
        <div class="cia-ferias-attendance-card-profile-record">
          <oxd-text tag="p" class="cia-ferias-attendance-card-state">
            {{ lastState }}
          </oxd-text>
          <oxd-text tag="p" class="cia-ferias-attendance-card-details">
            {{ lastRecord }}
          </oxd-text>
        </div>
      </div>
      <div class="cia-ferias-attendance-card-bar">
        <oxd-text tag="span" class="cia-ferias-attendance-card-fulltime">
        ...
        <oxd-icon-button
          ...
          class="cia-ferias-attendance-card-action"
          @click="onClickPunchIn"
        />
      </div>
      <oxd-divider />
      <div class="cia-ferias-attendance-card-summary">
        <div class="cia-ferias-attendance-card-summary-week">
          <oxd-text tag="p">
        ...
        <div class="cia-ferias-attendance-card-summary-total">
          <oxd-icon name="stopwatch" class="cia-ferias-attendance-card-icon" />
          <oxd-text tag="p" class="cia-ferias-attendance-card-fulltime">
...
import {OxdBarChart, OxdIcon, CHART_COLORS} from '@cia-ferias/oxd';
