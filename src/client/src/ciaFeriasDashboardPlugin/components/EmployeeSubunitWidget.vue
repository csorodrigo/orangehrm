...
<template>
  <base-widget
    icon="pie-chart-fill"
    class="cia-ferias-dashboard-widget-chart"
    :loading="isLoading"
...
import {OxdPieChart, CHART_COLORS} from '@cia-ferias/oxd';
...
.cia-ferias-dashboard-widget-chart {
  height: 450px;

  :deep(.cia-ferias-dashboard-widget-body) {
    height: auto;
    min-height: 360px;
    overflow: visible;
    padding-right: 0;
