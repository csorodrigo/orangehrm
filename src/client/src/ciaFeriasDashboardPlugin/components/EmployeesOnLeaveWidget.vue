...
<template>
  ...
  >
    ...
    >
      <oxd-icon
        class="cia-ferias-leave-card-icon"
        name="gear-fill"
        @click="onClickConfig"
      />
    </template>
    <div v-for="leave in leaveList" :key="leave" class="cia-ferias-leave-card">
      <div class="cia-ferias-leave-card-profile-image">
        <img
          alt="profile picture"
      ...
      <div class="cia-ferias-leave-card-details">
        <oxd-text tag="p" class="cia-ferias-leave-card-emp-name">
          {{ leave.empName }}
        </oxd-text>
        <oxd-text
          v-if="leave.leaveType"
          tag="p"
          class="cia-ferias-leave-card-leave-details"
        >
          {{ leave.leaveType }}
        </oxd-text>
      </div>
      <oxd-text tag="p" class="cia-ferias-leave-card-emp-id">
        {{ leave.employeeId }}
      </oxd-text>
    </div>
  </base-widget>
...
import EmployeesOnLeaveConfigModal from '@/ciaFeriasDashboardPlugin/components/EmployeesOnLeaveConfigModal.vue';
