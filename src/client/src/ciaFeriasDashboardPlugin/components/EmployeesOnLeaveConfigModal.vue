...
<template>
  <oxd-dialog class="cia-ferias-dialog-modal" @update:show="onCancel">
    <div class="cia-ferias-modal-header">
      ...
      <div class="cia-ferias-config-title">
    ...
    <oxd-form :loading="isLoading" @submit-valid="onSave">
      <oxd-form-row class="cia-ferias-config-checkbox">
        <oxd-input-field
...
import {OxdDialog, OxdIcon} from '@cia-ferias/oxd';
...
.cia-ferias-config-title {
  margin-left: 1rem;
}
.cia-ferias-config-checkbox {
  & .oxd-input-group {
    margin: 0;
    padding: 1rem 0;
    flex-direction: row;
