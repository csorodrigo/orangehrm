...
<template>
  <employee-records
    ...
    @search="search"
  ></employee-records>
  <div v-if="employee" class="cia-ferias-background-container">
    <selected-employee
...
<script>
import EmployeeRecords from '@/ciaFeriasMaintenancePlugin/components/EmployeeRecords';
import SelectedEmployee from '@/ciaFeriasMaintenancePlugin/components/SelectedEmployee';
import MaintenanceNote from '@/ciaFeriasMaintenancePlugin/components/MaintenanceNote';
