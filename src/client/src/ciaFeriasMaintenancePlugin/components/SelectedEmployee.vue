...
<template>
  <div class="cia-ferias-card-container">
    ...
    <oxd-form :loading="loading" @submit="emitEmpNumber">
      <div class="cia-ferias-selected-employee">
        <div class="cia-ferias-selected-employee-imagesection">
          <div class="cia-ferias-selected-employee-image-wrapper">
            <div class="cia-ferias-selected-employee-image">
              <img alt="profile picture" class="employee-image" :src="imgSrc" />
            </div>
          </div>
        </div>
        <div class="cia-ferias-selected-employee-content">
          <oxd-form-row>
