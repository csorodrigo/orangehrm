...
<template>
  ...
  <div v-if="vacancy" class="cia-ferias-paper-container">
    <div v-show="total > 0" class="cia-ferias-header-container">
      <oxd-button
...
import CandidateRecords from '@/ciaFeriasMaintenancePlugin/components/CandidateRecords';
