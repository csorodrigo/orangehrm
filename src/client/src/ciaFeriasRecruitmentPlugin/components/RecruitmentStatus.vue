...
<template>
  <div class="cia-ferias-card-container">
    <oxd-form :loading="isLoading">
      ...
      <oxd-divider />
      <div class="cia-ferias-recruitment">
        <div v-if="recruitmentStatus" class="cia-ferias-recruitment-status">
          <oxd-text type="subtitle-2">
            {{ $t('general.status') }}: {{ recruitmentStatus }}
          </oxd-text>
        </div>
        <div class="cia-ferias-recruitment-actions">
          <oxd-button
            v-if="hasWorkflow(3)"
