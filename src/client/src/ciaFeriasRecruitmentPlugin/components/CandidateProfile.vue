    ...
    <div class="cia-ferias-card-container">
      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
            <oxd-grid-item
              class="cia-ferias-save-candidate-page --span-column-2"
            >
              <oxd-input-field
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
            <oxd-grid-item class="cia-ferias-candidate-grid-checkbox">
              <oxd-input-field
...
.cia-ferias-header-container {
  padding: 0;
}
.cia-ferias-candidate-grid-checkbox {
  .oxd-input-group {
