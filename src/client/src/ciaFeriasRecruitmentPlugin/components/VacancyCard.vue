...
<template>
  <div class="cia-ferias-card-container">
    <div class="cia-ferias-vacancy-card-header">
    ...
    <div :class="{'cia-ferias-vacancy-card-body': isViewDetails}">
      <oxd-text type="toast-message">
        <pre
          v-if="vacancyDescription"
          class="cia-ferias-vacancy-card-pre-tag"
    ...
    >
      <a @click="viewDetails">
        <oxd-text tag="p" class="cia-ferias-vacancy-card-anchor-tag">
          {{
