 ...
 */
 -->
<template>
  <div class="cia-ferias-background-container cia-ferias-save-candidate-page">
    <div class="cia-ferias-card-container">
      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
            <oxd-grid-item class="cia-ferias-save-candidate-page-full-width">
              <oxd-input-field
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
            <oxd-grid-item
              class="cia-ferias-save-candidate-page-full-width cia-ferias-save-candidate-page-grid-checkbox"
            >
              <oxd-input-field
...
import {freshDate, formatDate} from '@cia-ferias/core/util/helper/datefns';
...
.cia-ferias-save-candidate-page {
  &-full-width {
