...
import CandidateActionLayout from '@/ciaFeriasRecruitmentPlugin/components/CandidateActionLayout.vue';
import InterviewerAutocomplete from '@/ciaFeriasRecruitmentPlugin/components/InterviewerAutocomplete.vue';
