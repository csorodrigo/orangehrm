  ...
  <div class="cia-ferias-background-container">
    <div class="cia-ferias-card-container">
      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        ...
        <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
          <oxd-grid-item class="cia-ferias-grid-item-span-2">
            <oxd-input-field
        ...
        <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
          <oxd-grid-item class="orangerhrm-switch-wrapper">
            <oxd-text class="cia-ferias-text" tag="p">
              {{ $t('general.active') }}
            </oxd-text>
        ...
        <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
          <oxd-grid-item class="cia-ferias-grid-item-span-2">
            <div class="cia-ferias-vacancy-links">
              <vacancy-link-card
    ...
    <div
      ...
      class="cia-ferias-card-container"
    >
      <oxd-text
        tag="h6"
        class="cia-ferias-main-title cia-ferias-attachment-header__title"
      >
    ...
    <div
      v-if="isEditClicked && !isAddClicked"
      class="cia-ferias-card-container"
    >
      <oxd-text
        tag="h6"
    ...
    <div class="cia-ferias-paper-container">
      <div class="cia-ferias-header-container cia-ferias-attachment-header">
        <oxd-text
          tag="h6"
          class="cia-ferias-main-title cia-ferias-attachment-header__title"
        >
...
import {OxdSwitchInput} from '@cia-ferias/oxd';
