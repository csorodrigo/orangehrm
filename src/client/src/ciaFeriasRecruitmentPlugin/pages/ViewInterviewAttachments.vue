...
<template>
  <div class="cia-ferias-attachment">
    ...
    ></edit-interview-attachment>
    <template v-else>
      <div class="cia-ferias-attachment-header">
...
import {convertFilesizeToString} from '@cia-ferias/core/util/helper/filesize';
import DeleteConfirmationDialog from '@cia-ferias/components/dialogs/DeleteConfirmationDialog.vue';
import SaveInterviewAttachment from '@/ciaFeriasRecruitmentPlugin/components/SaveInterviewAttachment.vue';
import EditInterviewAttachment from '@/ciaFeriasRecruitmentPlugin/components/EditInterviewAttachment.vue';
