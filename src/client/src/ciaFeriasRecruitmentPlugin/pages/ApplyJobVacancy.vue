...
<template>
  <div class="cia-ferias-container">
    <div class="cia-ferias-card-container">
      <div class="cia-ferias-card-container-header">
        <oxd-text class="cia-ferias-main-title" tag="h6">
          {{
      ...
      <template v-if="vacancyDescription">
        <oxd-divider />
        <oxd-text class="cia-ferias-vacancy-description" tag="p">
          {{ $t('general.description') }}
        </oxd-text>
        <oxd-text tag="p" :class="descriptionClasses">
          <pre class="cia-ferias-applicant-card-pre-tag"
            >{{ vacancyDescription }}
        </pre
          >
        </oxd-text>
        <div
          ...
          class="cia-ferias-vacancy-card-footer"
        >
          <oxd-text
            tag="p"
            class="cia-ferias-vacancy-card-anchor-tag"
            @click="onToggleMore"
          >
            {{
      ...
      >
        ...
        <div class="cia-ferias-applicant-container">
          <oxd-form-row class="cia-ferias-applicant-container-row">
            <oxd-grid :cols="1" class="cia-ferias-full-width-grid">
              <oxd-grid-item>
                <full-name-input
          ...
          <oxd-form-row class="cia-ferias-applicant-container-row">
            <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
              <oxd-grid-item class="cia-ferias-applicant-container-colspan-2">
                <oxd-input-field
            ...
            <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
              <oxd-grid-item>
                <oxd-input-field
                  ...
                  required
                />
                <oxd-text class="cia-ferias-input-hint" tag="p">
                  {{
          ...
          <oxd-form-row>
            <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
              <oxd-grid-item
                class="cia-ferias-applicant-container-colspan-2 cia-ferias-applicant-container-grid-checkbox"
              >
                <oxd-input-field
...
import FullNameInput from '@/ciaFeriasPimPlugin/components/FullNameInput';
import SuccessDialog from '@/ciaFeriasRecruitmentPlugin/components/SuccessDialog';
import {
  maxFileSize,
  required,
...
import {useResponsive} from '@cia-ferias/oxd';
...
export default {
  ...
  computed: {
    ...
    descriptionClasses() {
      return {
        'cia-ferias-vacancy-description': true,
        'cia-ferias-vacancy-card-body': !this.isViewDetails,
      };
    },
    isMobile() {
