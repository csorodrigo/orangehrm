...
<template>
  <div class="cia-ferias-candidate-page">
    ...
    <div class="cia-ferias-paper-container">
      <div
        ...
        class="cia-ferias-header-container"
      >
        <oxd-button
          :label="$t('general.add')"
          icon-name="plus"
...
import useSort from '@cia-ferias/core/util/composable/useSort';
...
import JobtitleDropdown from '@/ciaFeriasPimPlugin/components/JobtitleDropdown';
import VacancyDropdown from '@/ciaFeriasRecruitmentPlugin/components/VacancyDropdown';
import useEmployeeNameTranslate from '@/core/util/composable/useEmployeeNameTranslate';
import DeleteConfirmationDialog from '@cia-ferias/components/dialogs/DeleteConfirmationDialog';
import CandidateAutocomplete from '@/ciaFeriasRecruitmentPlugin/components/CandidateAutocomplete';
import HiringManagerDropdown from '@/ciaFeriasRecruitmentPlugin/components/HiringManagerDropdown';
import CandidateStatusDropdown from '@/ciaFeriasRecruitmentPlugin/components/CandidateStatusDropdown';
