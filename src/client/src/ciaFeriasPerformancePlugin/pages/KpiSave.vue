      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        ...
        <oxd-form-row>
          <oxd-grid :cols="4" class="cia-ferias-full-width-grid">
            ...
            <oxd-grid-item>
              <div class="cia-ferias-module-field-row">
                <oxd-text tag="p" class="cia-ferias-module-field-label">
...
import JobtitleDropdown from '@/ciaFeriasPimPlugin/components/JobtitleDropdown.vue';
