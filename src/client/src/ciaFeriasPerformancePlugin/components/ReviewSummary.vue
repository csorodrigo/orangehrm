...
<template>
  <div class="cia-ferias-card-container">
    <div class="cia-ferias-performance-review-summary">
      <oxd-text tag="h5" class="cia-ferias-performance-review-title">
        {{ $t('performance.review_summary') }}
      </oxd-text>
      <oxd-form :loading="loading">
        <oxd-form-row class="cia-ferias-performance-review-details">
          <oxd-grid
            :cols="3"
            class="cia-ferias-performance-review-details-grid"
          >
            <oxd-grid-item>
              <div class="cia-ferias-performance-review-owner">
                <img
                  alt="profile picture"
                ...
                />
                <div
                  class="cia-ferias-performance-review-owner-employee-section"
                >
                  <div class="cia-ferias-performance-review-owner-employee">
                    <oxd-text
                      tag="h5"
                      class="cia-ferias-performance-review-owner-employee-name"
                    >
                      {{ employeeName }}
                    </oxd-text>
                    <oxd-text
                      tag="h6"
                      class="cia-ferias-performance-review-owner-employee-job"
                    >
                      {{ jobTitle }}
                    </oxd-text>
                  </div>
            ...
            <oxd-grid-item v-show="status === 4">
              <div class="cia-ferias-performance-review-rating">
                <oxd-text type="subtitle-2">
                  {{ $t('performance.final_rating') }}
                </oxd-text>
                <oxd-text
                  tag="h4"
                  class="cia-ferias-performance-review-rating-number"
                >
                  {{ finalRating }}
                </oxd-text>
              </div>
        ...
        <oxd-form-row class="cia-ferias-performance-review-details">
          <oxd-grid
            ...
            class="cia-ferias-performance-review-details-grid"
          >
            <oxd-grid-item class="cia-ferias-performance-review-column">
              <oxd-text type="subtitle-2">
                {{ $t('performance.review_status') }}
              </oxd-text>
              <oxd-text class="cia-ferias-performance-review-bold">
                {{ reviewStatus }}
              </oxd-text>
            </oxd-grid-item>
            <oxd-grid-item class="cia-ferias-performance-review-column">
