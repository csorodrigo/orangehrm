...
<template>
  <div>
    <oxd-text class="cia-ferias-performance-review-title">
      {{ $t('performance.review_finalization') }}
    </oxd-text>
    <br />
    <oxd-grid :cols="4" class="cia-ferias-performance-review-grid">
      <oxd-grid-item>
        ...
        />
        <div v-else class="cia-ferias-performance-review-read">
          <oxd-text>{{ formattedCompletedDate }}</oxd-text>
        </div>
      </oxd-grid-item>
      <oxd-grid-item class="cia-ferias-performance-review-grid-rating">
        <oxd-text type="subtitle-2">
