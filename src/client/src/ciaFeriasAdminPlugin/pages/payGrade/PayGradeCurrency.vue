...
<script>
import InlineActionButton from '@/ciaFeriasAdminPlugin/components/InlineActionButton.vue';
...
import SavePayCurrency from '@/ciaFeriasAdminPlugin/pages/payGrade/SavePayCurrency.vue';
import EditPayCurrency from '@/ciaFeriasAdminPlugin/pages/payGrade/EditPayCurrency.vue';
