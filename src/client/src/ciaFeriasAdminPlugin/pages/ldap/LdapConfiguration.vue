  ...
  <div class="cia-ferias-background-container">
    <div class="cia-ferias-card-container">
      ...
      <oxd-form ref="formRef" :loading="isLoading">
        <oxd-text tag="p" class="cia-ferias-subtitle">
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
            ...
            <oxd-grid-item class="cia-ferias-column-half">
              <oxd-input-field
        ...
        <oxd-divider class="cia-ferias-form-divider" />
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
            <oxd-grid-item class="cia-ferias-ldap-switch">
              <oxd-text tag="p" class="cia-ferias-ldap-switch-text">
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="cia-ferias-ldap-grid">
            <oxd-grid-item class="cia-ferias-ldap-grid-header">
              <oxd-text tag="p">
                {{ $t('admin.field_in_cia_ferias') }}
              </oxd-text>
            </oxd-grid-item>
            <oxd-grid-item class="cia-ferias-ldap-grid-header">
              <oxd-text tag="p">
            ...
            <oxd-grid-item class="cia-ferias-ldap-grid-content">
              <oxd-text tag="p" class="oxd-input-field-required">
                {{ $t('general.first_name') }}
              </oxd-text>
              <oxd-icon class="cia-ferias-ldap-grid-icon" name="arrow-left" />
            </oxd-grid-item>
            <oxd-grid-item>
              <oxd-input-field
        ...
        <oxd-form-row>
          <oxd-grid :cols="3" class="cia-ferias-full-width-grid">
            <oxd-grid-item class="cia-ferias-ldap-switch --offset-row-1">
              <oxd-text tag="p" class="cia-ferias-ldap-switch-text">
...
import LdapSyncConnection from '@/ciaFeriasAdminPlugin/components/LdapSyncConnection';
import LdapTestConnectionModal from '@/ciaFeriasAdminPlugin/components/LdapTestConnectionModal';
import {OxdAlert, OxdIcon, OxdSwitchInput} from '@cia-ferias/oxd';
