    ...
    <div class="cia-ferias-card-container">
      ...
      <oxd-form ref="formRef" :loading="isLoading" @submit-valid="onFormSubmit">
        ...
        <oxd-form-row>
          <oxd-grid :cols="4" class="cia-ferias-full-width-grid">
            <oxd-grid-item>
              <div class="cia-ferias-sm-field">
                <oxd-text tag="p" class="cia-ferias-sm-field-label">
        ...
        <oxd-form-actions>
          <required-text />
          <div class="cia-ferias-actions-group">
            <oxd-button
              type="button"
              display-type="ghost"
...
import InlineColorInput from '@/ciaFeriasAdminPlugin/components/InlineColorInput';
