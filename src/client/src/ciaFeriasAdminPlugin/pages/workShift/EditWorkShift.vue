  ...
  <div class="cia-ferias-background-container">
    <div class="cia-ferias-card-container">
      ...
      <oxd-form :loading="isLoading" @submit-valid="onSave">
        ...
        <oxd-form-row>
          <oxd-text class="cia-ferias-sub-title">Working Hours*</oxd-text>
          <oxd-grid :cols="4" class="cia-ferias-full-width-grid">
            ...
            <oxd-grid-item>
              <oxd-input-group :label="$t('admin.duration_per_day')">
                <oxd-text class="cia-ferias-workshift-duration" tag="p">
...
import WorkShiftEmployeeAutocomplete from '@/ciaFeriasAdminPlugin/components/WorkShiftEmployeeAutocomplete';
