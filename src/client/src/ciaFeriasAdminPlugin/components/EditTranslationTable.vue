...
<template>
  <div class="cia-ferias-translation-container">
    <oxd-divider />
    <oxd-grid :cols="3" class="cia-ferias-translation-grid">
      <oxd-grid-item class="cia-ferias-translation-grid-header">
      ...
      <template v-for="(langstring, index) in langstrings" :key="index">
        <oxd-grid-item class="cia-ferias-translation-grid-text">
          <oxd-text
            class="cia-ferias-translation-grid-langstring-header"
            type="card-title"
          >
            {{ $t('admin.source_text') }}
          </oxd-text>
        ...
        <oxd-grid-item class="cia-ferias-translation-grid-text">
          <oxd-text
            class="cia-ferias-translation-grid-langstring-header-note"
            type="card-title"
          >
            {{ $t('admin.source_note') }}
          </oxd-text>
          <oxd-text
            ...
            class="cia-ferias-translation-grid-header"
          >
            {{ langstring.note }}
          </oxd-text>
        </oxd-grid-item>
        <oxd-grid-item class="cia-ferias-translation-grid-text">
          ...
          />
          <oxd-divider class="cia-ferias-translation-grid-langstring-header" />
        </oxd-grid-item>
      </template>
    </oxd-grid>
    <oxd-divider />
...
<script>
import LangStringTargetInput from '@/ciaFeriasAdminPlugin/components/LangStringTargetInput.vue';
