...
namespace CiaFerias\Help\Service;

use CiaFerias\Help\Processor\HelpProcessor;
...
class HelpService
{
    ...
    public function getHelpProcessor(): HelpProcessor
    {
        if (!$this->helpProcessorClass instanceof HelpProcessor) {
            $helpProcessorClassName = 'CiaFerias\\Help\\Processor\\' . $this->getHelpConfigService()->getHelpProcessorClass();
