...
use CiaFerias\Entity\Decorator\I18NTranslationDecorator;

/**
 * @method I18NTranslationDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_i18n_translate", uniqueConstraints={@ORM\UniqueConstraint(name="translateUniqueId", columns={"lang_string_id", "language_id"})})
 * @ORM\Entity
 */
class I18NTranslation
{
     ...
     * @var I18NLangString
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\I18NLangString", inversedBy="translations")
     ...
     * @var I18NLanguage
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\I18NLanguage")
