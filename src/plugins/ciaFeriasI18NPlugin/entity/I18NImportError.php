...
use CiaFerias\Entity\Decorator\I18NImportErrorDecorator;

/**
 * @method I18NImportErrorDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_i18n_import_error")
 * @ORM\Entity
 */
class I18NImportError
{
     ...
     * @var I18NLangString
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\I18NLangString")
     ...
     * @var I18NError
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\I18NError")
