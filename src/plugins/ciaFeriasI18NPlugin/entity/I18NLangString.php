...
/**
 * @ORM\Table(name="cia_ferias_i18n_lang_string")
 * @ORM\Entity
 */
class I18NLangString
{
     ...
     * @var I18NGroup|null
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\I18NGroup")
     ...
     * @var I18NTranslation[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\I18NTranslation", mappedBy="langString")
     */
