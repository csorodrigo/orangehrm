...
use CiaFerias\Leave\Api\Model\LeaveCommentModel;
...
class LeaveCommentAPI extends Endpoint implements CollectionEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="comment", type="string", maxLength=CiaFerias\Leave\Api\LeaveCommentAPI::PARAM_RULE_COMMENT_MAX_LENGTH),
     *             required={"comment"}
     *         )
     *     ),
