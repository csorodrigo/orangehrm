...
use CiaFerias\Leave\Dto\LeaveTypeSearchFilterParams;
...
class LeaveTypeAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=CiaFerias\Leave\Api\LeaveTypeAPI::PARAM_RULE_NAME_MAX_LENGTH),
