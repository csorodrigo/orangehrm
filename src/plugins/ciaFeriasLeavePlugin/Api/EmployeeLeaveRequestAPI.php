...
use CiaFerias\Leave\Api\Model\LeaveRequestDetailedModel;
use CiaFerias\Leave\Api\Model\LeaveRequestModel;
use CiaFerias\Leave\Api\Traits\LeaveRequestParamHelperTrait;
use CiaFerias\Leave\Api\Traits\LeaveRequestPermissionTrait;
use CiaFerias\Leave\Api\ValidationRules\LeaveTypeIdRule;
use CiaFerias\Leave\Dto\LeaveRequest\DetailedLeaveRequest;
use CiaFerias\Leave\Dto\LeaveRequestSearchFilterParams;
use CiaFerias\Leave\Exception\LeaveAllocationServiceException;
use CiaFerias\Leave\Service\LeaveAssignmentService;
...
class EmployeeLeaveRequestAPI extends Endpoint implements CrudEndpoint
{
     ...
     *             type="string",
     *             enum={
     *                 CiaFerias\Leave\Api\EmployeeLeaveRequestAPI::MODEL_DEFAULT,
     *                 CiaFerias\Leave\Api\EmployeeLeaveRequestAPI::MODEL_DETAILED
     *             },
     *             default=CiaFerias\Leave\Api\EmployeeLeaveRequestAPI::MODEL_DEFAULT
     *         )
     *     ),
     *     @OA\Response(
     *         response="200",
