...
use CiaFerias\Leave\Api\Model\LeaveEntitlementModel;
use CiaFerias\Leave\Api\Model\LeaveEntitlementSummaryModel;
use CiaFerias\Leave\Api\Traits\LeaveEntitlementPermissionTrait;
...
class LeaveEntitlementAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={\CiaFerias\Leave\Api\LeaveEntitlementAPI::MODEL_DEFAULT, \CiaFerias\Leave\Api\LeaveEntitlementAPI::MODEL_SUMMARY},
     *             default=\CiaFerias\Leave\Api\LeaveEntitlementAPI::MODEL_DEFAULT
     *         )
     *     ),
     *     @OA\Response(
     *         response="200",
