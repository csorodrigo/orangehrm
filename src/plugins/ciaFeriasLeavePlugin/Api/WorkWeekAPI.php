...
use CiaFerias\Leave\Api\Model\WorkWeekIndexedModel;
use CiaFerias\Leave\Api\Model\WorkWeekModel;
use CiaFerias\Leave\Traits\Service\WorkWeekServiceTrait;
...
class WorkWeekAPI extends Endpoint implements ResourceEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={CiaFerias\Leave\Api\WorkWeekAPI::MODEL_DEFAULT, CiaFerias\Leave\Api\WorkWeekAPI::MODEL_INDEXED},
     *             default=CiaFerias\Leave\Api\WorkWeekAPI::MODEL_DEFAULT
     *         )
     *     ),
     *     @OA\Response(
     *         response="200",
