...
/**
 * @ORM\Table(name="cia_ferias_leave_type")
 * @ORM\Entity
 */
class LeaveType
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\OperationalCountry")
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\LeaveEntitlement", mappedBy="leaveType")
     */
