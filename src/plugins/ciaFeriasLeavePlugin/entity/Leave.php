 ...
 *
 * @ORM\Table(name="cia_ferias_leave")
 * @ORM\Entity
 */
class Leave
{
     ...
     * @var LeaveRequest
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\LeaveRequest", inversedBy="leaves")
     ...
     * @var LeaveType
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\LeaveType")
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\LeaveLeaveEntitlement", mappedBy="leave")
     */
