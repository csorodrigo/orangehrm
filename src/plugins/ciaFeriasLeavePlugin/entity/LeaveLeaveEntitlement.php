...
use CiaFerias\Entity\Decorator\LeaveLeaveEntitlementDecorator;

/**
 * @method LeaveLeaveEntitlementDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_leave_leave_entitlement")
 * @ORM\Entity
 */
class LeaveLeaveEntitlement
{
     ...
     * @var Leave
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Leave", inversedBy="leaveLeaveEntitlements")
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\LeaveEntitlement", inversedBy="leaveLeaveEntitlements")
