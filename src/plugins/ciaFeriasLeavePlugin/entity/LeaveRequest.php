...
use CiaFerias\Entity\Decorator\LeaveRequestDecorator;

/**
 * @method LeaveRequestDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_leave_request")
 * @ORM\Entity
 */
class LeaveRequest
{
     ...
     * @var Leave[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\Leave", mappedBy="leaveRequest")
     */
