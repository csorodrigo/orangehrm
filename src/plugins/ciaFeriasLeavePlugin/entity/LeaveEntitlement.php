...
use CiaFerias\Entity\Decorator\LeaveEntitlementDecorator;

/**
 * @method LeaveEntitlementDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_leave_entitlement")
 * @ORM\Entity
 */
class LeaveEntitlement
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee")
     ...
     * @var LeaveType
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\LeaveType", inversedBy="leaveEntitlement")
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\LeaveEntitlementType")
     ...
     * @var User
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\User")
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\LeaveLeaveEntitlement", mappedBy="entitlement")
     */
