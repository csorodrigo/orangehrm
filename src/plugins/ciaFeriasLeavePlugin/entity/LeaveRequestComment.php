...
use CiaFerias\Entity\Decorator\LeaveRequestCommentDecorator;

/**
 * @method LeaveRequestCommentDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_leave_request_comment")
 * @ORM\Entity
 */
class LeaveRequestComment
{
     ...
     * @var LeaveRequest
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\LeaveRequest")
