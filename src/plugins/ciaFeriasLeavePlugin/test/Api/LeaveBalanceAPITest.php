...
use CiaFerias\Leave\Api\LeaveBalanceAPI;
use CiaFerias\Leave\Api\LeaveCommonParams;
use CiaFerias\Leave\Dao\LeaveTypeDao;
use CiaFerias\Leave\Dto\LeaveDuration;
use CiaFerias\Leave\Dto\LeaveParameterObject;
use CiaFerias\Leave\Service\HolidayService;
use CiaFerias\Leave\Service\LeaveApplicationService;
use CiaFerias\Leave\Service\LeaveConfigurationService;
use CiaFerias\Leave\Service\LeaveEntitlementService;
use CiaFerias\Leave\Service\LeavePeriodService;
use CiaFerias\Leave\Service\LeaveRequestService;
use CiaFerias\Leave\Service\LeaveTypeService;
use CiaFerias\Leave\Service\WorkScheduleService;
use CiaFerias\Leave\Service\WorkWeekService;
use CiaFerias\Pim\Service\EmployeeService;
use CiaFerias\Tests\Util\EndpointTestCase;
use CiaFerias\Tests\Util\MockObject;
...
class LeaveBalanceAPITest extends EndpointTestCase
{
    ...
    public function testGetOneSingleDay(
        ...
        $userRoleManager->setUser($this->getEntityReference(\CiaFerias\Entity\User::class, 1));
        $authUser = $this->getMockBuilder(User::class)
            ->onlyMethods(['getEmpNumber'])
            ->disableOriginalConstructor()
            ->getMock();
