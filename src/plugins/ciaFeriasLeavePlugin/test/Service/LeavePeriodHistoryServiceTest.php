...
class LeavePeriodHistoryServiceTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $fixture = Config::get(Config::PLUGINS_DIR) .
            '/ciaFeriasLeavePlugin/test/fixtures/LeavePeriodHistoryService.yml';
        TestDataService::truncateSpecificTables([LeavePeriodHistory::class, \CiaFerias\Entity\Config::class]);
