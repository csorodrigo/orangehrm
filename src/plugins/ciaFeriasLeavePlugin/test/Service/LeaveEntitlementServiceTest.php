...
use CiaFerias\Leave\Dto\CurrentAndChangeEntitlement;
use CiaFerias\Leave\Dto\LeavePeriod;
use CiaFerias\Leave\Entitlement\EntitlementConsumptionStrategy;
use CiaFerias\Leave\Entitlement\FIFOEntitlementConsumptionStrategy;
...
class LeaveEntitlementServiceTest extends KernelTestCase
{
    ...
    protected function loadFixtures(): void
    {
        ...
        $fixture = Config::get(Config::PLUGINS_DIR) .
            '/ciaFeriasLeavePlugin/test/fixtures/LeaveEntitlementService.yml';
