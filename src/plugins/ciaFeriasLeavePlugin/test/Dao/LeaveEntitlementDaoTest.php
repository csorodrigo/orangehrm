...
namespace CiaFerias\Tests\Leave\Dao;
...
class LeaveEntitlementDaoTest extends KernelTestCase
{
    ...
    {
        return Config::get(Config::PLUGINS_DIR) . '/ciaFeriasLeavePlugin/test/fixtures/LeaveEntitlement.yml';
    }
    ...
    public function xtestBulkAssignLeaveEntitlementsLinkingOfUnlinkedLeave()
    {
        ...
        $statement = $conn->prepare('SELECT * FROM cia_ferias_leave_leave_entitlement e WHERE e.leave_id = ?');
        $leaveIds = [11, 12];
