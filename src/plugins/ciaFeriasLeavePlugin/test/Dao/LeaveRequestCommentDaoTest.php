...
use CiaFerias\Leave\Dao\LeaveRequestCommentDao;
use CiaFerias\Leave\Dto\LeaveCommentSearchFilterParams;
...
class LeaveRequestCommentDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ) . '/ciaFeriasLeavePlugin/test/fixtures/LeaveRequestCommentDao.yml';
