...
namespace CiaFerias\Tests\Leave\Dto\LeaveRequest;
...
class DetailedLeaveRequestTest extends KernelTestCase
{
    ...
    {
        $fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasLeavePlugin/test/fixtures/DetailedLeaveRequest.yaml';
    ...
    public function testEmptyLeaveRequest(): void
    {
        ...
        try {
            ...
            $this->assertEquals(
                'Cannot access uninitialized non-nullable property CiaFerias\Leave\Dto\LeaveRequest\DetailedLeaveRequest::$leaveDates by reference',
                $e->getMessage()
            );
        }
