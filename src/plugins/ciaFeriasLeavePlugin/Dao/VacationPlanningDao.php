...
class VacationPlanningDao extends BaseDao
{
    ...
    public function getPreference(int $empNumber): array
    {
        ...
        $row = $this->getEntityManager()->getConnection()->fetchAssociative(
            'SELECT * FROM cia_ferias_ca_vacation_preference WHERE emp_number = ?',
            [$empNumber]
        );
    ...
    public function savePreference(int $empNumber, array $preference): array
    {
        ...
        $connection->executeStatement(
            'INSERT INTO cia_ferias_ca_vacation_preference (
                emp_number,
                option_a_from,
                option_a_to,
                option_b_from,
    ...
    public function getPlanningEmployees(?int $empNumber = null, ?int $subunitId = null): array
    {
        ...
        $rows = $connection->fetchAllAssociative(
            ...
            LEFT JOIN cia_ferias_job_title jt ON jt.id = e.job_title_code
            LEFT JOIN cia_ferias_subunit s ON s.id = e.work_station
            LEFT JOIN cia_ferias_ca_vacation_preference p ON p.emp_number = e.emp_number
    ...
    private function ensurePreferenceTable(): void
    {
        ...
        $this->getEntityManager()->getConnection()->executeStatement(
            'CREATE TABLE IF NOT EXISTS cia_ferias_ca_vacation_preference (
