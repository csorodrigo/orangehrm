...
use CiaFerias\Claim\Api\Model\MyClaimRequestModel;
...
class MyClaimRequestAPI extends EmployeeClaimRequestAPI
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={\CiaFerias\Claim\Api\MyClaimRequestAPI::MODEL_DEFAULT, \CiaFerias\Claim\Api\MyClaimRequestAPI::MODEL_SUMMARY},
     *             default=\CiaFerias\Claim\Api\MyClaimRequestAPI::MODEL_DEFAULT
     *         )
     *     ),
