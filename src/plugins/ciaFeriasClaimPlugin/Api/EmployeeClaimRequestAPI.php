...
use CiaFerias\Claim\Api\Model\ClaimRequestSummaryModel;
use CiaFerias\Claim\Api\Model\EmployeeClaimRequestModel;
use CiaFerias\Claim\Dto\ClaimRequestSearchFilterParams;
use CiaFerias\Claim\Dto\EmployeeClaimRequestSearchFilterParams;
...
class EmployeeClaimRequestAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={\CiaFerias\Claim\Api\EmployeeClaimRequestAPI::MODEL_DEFAULT, \CiaFerias\Claim\Api\EmployeeClaimRequestAPI::MODEL_SUMMARY},
     *             default=\CiaFerias\Claim\Api\EmployeeClaimRequestAPI::MODEL_DEFAULT
     *         )
     *     ),
