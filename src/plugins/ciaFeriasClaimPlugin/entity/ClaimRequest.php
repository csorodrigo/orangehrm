...
use CiaFerias\Entity\Decorator\ClaimRequestDecorator;
use CiaFerias\Entity\Decorator\DecoratorTrait;

/**
 * @method ClaimRequestDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_claim_request")
 * @ORM\Entity
 */
class ClaimRequest
{
     ...
     * @var ClaimEvent
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\ClaimEvent")
     ...
     * @var CurrencyType
     *
     * @ORM\OneToOne(targetEntity="CiaFerias\Entity\CurrencyType", cascade={"persist"})
