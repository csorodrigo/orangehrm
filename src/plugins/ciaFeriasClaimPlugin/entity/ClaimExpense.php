...
class ClaimExpense
{
    ...
    /**
     * @var ExpenseType
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\ExpenseType")
    ...
    /**
     * @var ClaimRequest
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\ClaimRequest", inversedBy="claimExpenses")
