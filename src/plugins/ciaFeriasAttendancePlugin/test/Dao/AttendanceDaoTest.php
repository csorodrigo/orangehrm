...
namespace CiaFerias\Tests\Attendance\Dao;

use DateTime;
use DateTimeZone;
use Exception;
use CiaFerias\Admin\Service\CompanyStructureService;
use CiaFerias\Attendance\Dao\AttendanceDao;
use CiaFerias\Attendance\Dto\AttendanceRecordSearchFilterParams;
use CiaFerias\Attendance\Dto\EmployeeAttendanceSummarySearchFilterParams;
...
class AttendanceDaoTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ).'/ciaFeriasAttendancePlugin/test/fixtures/AttendanceDaoTest.yaml';
    ...
    {
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasTimePlugin/test/fixtures/AttendanceReportDataAPITest.yaml';
        TestDataService::populate($this->fixture);
