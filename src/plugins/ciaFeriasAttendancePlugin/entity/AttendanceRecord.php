...
use CiaFerias\Entity\Decorator\AttendanceRecordDecorator;
use CiaFerias\Entity\Decorator\DecoratorTrait;

/**
 * @method AttendanceRecordDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_attendance_record")
 * @ORM\Entity
 *
 */
class AttendanceRecord
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="attendanceRecords", cascade={"persist", "remove"})
