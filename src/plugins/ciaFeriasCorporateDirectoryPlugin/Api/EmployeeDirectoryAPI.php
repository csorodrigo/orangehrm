...
namespace CiaFerias\CorporateDirectory\Api;
...
use CiaFerias\CorporateDirectory\Api\Model\EmployeeDirectoryDetailedModel;
use CiaFerias\CorporateDirectory\Api\Model\EmployeeDirectoryModel;
use CiaFerias\CorporateDirectory\Dto\EmployeeDirectorySearchFilterParams;
use CiaFerias\CorporateDirectory\Service\EmployeeDirectoryService;
...
class EmployeeDirectoryAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={CiaFerias\CorporateDirectory\Api\EmployeeDirectoryAPI::MODEL_DEFAULT, CiaFerias\CorporateDirectory\Api\EmployeeDirectoryAPI::MODEL_DETAILED, CiaFerias\CorporateDirectory\Api\EmployeeDirectoryAPI::MODEL_DETAILED},
     *             default=CiaFerias\CorporateDirectory\Api\EmployeeDirectoryAPI::MODEL_DEFAULT
     *         )
     *     ),
     *     @OA\Response(
     *         response="200",
     ...
     *             type="string",
     *             enum={
     *                 CiaFerias\CorporateDirectory\Api\EmployeeDirectoryAPI::MODEL_DEFAULT,
     *                 CiaFerias\CorporateDirectory\Api\EmployeeDirectoryAPI::MODEL_DETAILED
     *             },
     *             default=CiaFerias\CorporateDirectory\Api\EmployeeDirectoryAPI::MODEL_DEFAULT
     *         )
     *     ),
