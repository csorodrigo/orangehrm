...
use CiaFerias\Pim\Api\EmployeeAPI;
...
class ProjectAdminAPI extends Endpoint implements CollectionEndpoint
{
     ...
     *         @OA\Schema(
     *             type="integer",
     *             enum=CiaFerias\Pim\Dto\EmployeeSearchFilterParams::INCLUDE_EMPLOYEES_MAP
     *         )
     *     ),
     *     @OA\Parameter(
     *         name="name",
     ...
     *         @OA\Schema(
     *             type="string",
     *             maxLength=CiaFerias\Pim\Api\EmployeeAPI::PARAM_RULE_FILTER_NAME_MAX_LENGTH
     *         )
     *     ),
     *     @OA\Parameter(
     *         name="nameOrId",
