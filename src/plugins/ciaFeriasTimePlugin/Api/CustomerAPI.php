...
use CiaFerias\Time\Api\Model\CustomerModel;
...
class CustomerAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="name",
     *                 type="string",
     *                 maxLength=CiaFerias\Time\Api\CustomerAPI::PARAM_RULE_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="description",
     *                 type="string",
     *                 maxLength=CiaFerias\Time\Api\CustomerAPI::PARAM_RULE_DESCRIPTION_MAX_LENGTH
     *             ),
     *             required={"name"}
     *         )
     *     ),
