...
use CiaFerias\Core\Api\V2\Serializer\NormalizeException;
...
use CiaFerias\Time\Api\Model\TimesheetModel;
use CiaFerias\Time\Api\Traits\TimesheetPermissionTrait;
use CiaFerias\Time\Api\ValidationRules\MyTimesheetActionRule;
use CiaFerias\Time\Api\ValidationRules\TimesheetDateRule;
use CiaFerias\Time\Dto\TimesheetSearchFilterParams;
use CiaFerias\Time\Service\TimesheetService;
...
class EmployeeTimesheetAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="action",
     *                 type="string",
     *                 enum=CiaFerias\Time\Service\TimesheetService::TIMESHEET_ACTION_MAP
     *             ),
     *             @OA\Property(
     *                 property="comment",
     *                 type="string",
     *                 maxLength=CiaFerias\Time\Api\EmployeeTimesheetAPI::PARAM_RULE_COMMENT_MAX_LENGTH
     *             ),
     *             required={"date"}
     *         )
     *     ),
