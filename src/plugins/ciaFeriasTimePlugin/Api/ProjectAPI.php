...
use CiaFerias\Core\Api\V2\Validator\Rules\InAccessibleEntityIdOption;
use CiaFerias\Core\Authorization\Manager\BasicUserRoleManager;
use CiaFerias\Core\Authorization\UserRole\ProjectAdminUserRole;
...
use CiaFerias\Time\Api\Model\ProjectDetailedModel;
use CiaFerias\Time\Api\Model\ProjectModel;
use CiaFerias\Time\Dto\ProjectSearchFilterParams;
...
class ProjectAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             maxLength=CiaFerias\Time\Api\ProjectAPI::PARAMETER_RULE_NAME_MAX_LENGTH
     *         )
     *     ),
     *     @OA\Parameter(
     *         name="empNumber",
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={CiaFerias\Time\Api\ProjectAPI::MODEL_DEFAULT, CiaFerias\Time\Api\ProjectAPI::MODEL_DETAILED},
     *             default=CiaFerias\Time\Api\ProjectAPI::MODEL_DEFAULT
     *         )
     *     ),
     ...
     *                 type="string",
     *                 maxLength=CiaFerias\Time\Api\ProjectAPI::PARAMETER_RULE_DESCRIPTION_MAX_LENGTH
     *             ),
