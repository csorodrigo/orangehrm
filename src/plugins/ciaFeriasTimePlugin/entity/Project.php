...
use CiaFerias\Entity\Decorator\ProjectDecorator;

/**
 * @method ProjectDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_project")
 * @ORM\Entity
 *
 */
class Project
{
     ...
     * @var Customer
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Customer", inversedBy="projects", cascade={"persist", "remove"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="CiaFerias\Entity\Employee", cascade={"persist", "remove"})
     * @ORM\JoinTable(
     *     name="cia_ferias_project_admin",
