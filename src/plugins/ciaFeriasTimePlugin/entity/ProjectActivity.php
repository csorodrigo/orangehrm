...
use CiaFerias\Entity\Decorator\ProjectActivityDecorator;

/**
 * @method ProjectActivityDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_project_activity")
 * @ORM\Entity
 */
class ProjectActivity
{
     ...
     * @var TimesheetItem[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\TimesheetItem", mappedBy="projectActivity")
     */
