...
use CiaFerias\Entity\Decorator\TimesheetItemDecorator;

/**
 * @method TimesheetItemDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_timesheet_item")
 * @ORM\Entity
 */
class TimesheetItem
{
     ...
     * @var Timesheet
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Timesheet")
     ...
     * @var Project
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Project")
     ...
     * @var ProjectActivity
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\ProjectActivity", inversedBy="timesheetItems")
