...
use CiaFerias\Time\Dao\ProjectActivityDao;
use CiaFerias\Time\Dto\ProjectActivitySearchFilterParams;
use CiaFerias\Time\Exception\ProjectServiceException;
...
class ProjectActivityDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasTimePlugin/test/fixtures/ProjectActivityDao.yml';
