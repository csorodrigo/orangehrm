...
namespace CiaFerias\Tests\Time\Dao;
...
use CiaFerias\Time\Dao\TimesheetDao;
use CiaFerias\Time\Dto\DefaultTimesheetSearchFilterParams;
use CiaFerias\Time\Dto\EmployeeReportsSearchFilterParams;
use CiaFerias\Time\Dto\EmployeeTimesheetListSearchFilterParams;
use CiaFerias\Time\Dto\TimesheetActionLogSearchFilterParams;
use CiaFerias\Time\Dto\TimesheetSearchFilterParams;
...
class TimesheetDaoTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasTimePlugin/test/fixtures/TimesheetDao.yml';
    ...
    {
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasTimePlugin/test/fixtures/TimesheetActionLogDao.yml';
        TestDataService::populate($this->fixture);
    ...
    {
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasTimePlugin/test/fixtures/MyTimesheetAPITest.yml';
        TestDataService::populate($this->fixture);
    ...
    {
        $this->fixture = Config::get(Config::PLUGINS_DIR).'/ciaFeriasTimePlugin/test/fixtures/TimesheetProjectActivityAPITest.yml';
        TestDataService::populate($this->fixture);
    ...
    {
        $this->fixture = Config::get(Config::PLUGINS_DIR).'/ciaFeriasTimePlugin/test/fixtures/DefaultTimesheetTest.yml';
        TestDataService::populate($this->fixture);
    ...
    public function testGetTimesheetItemsForEmployeeReportAndTotalHours(): void
    {
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ).'/ciaFeriasTimePlugin/test/fixtures/EmployeeReportDataTest.yml';
        TestDataService::populate($this->fixture);
        //without filters
