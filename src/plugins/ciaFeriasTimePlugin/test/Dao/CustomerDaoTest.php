...
use CiaFerias\Time\Dao\CustomerDao;
use CiaFerias\Time\Dao\ProjectDao;
use CiaFerias\Time\Dto\CustomerSearchFilterParams;
use CiaFerias\Time\Dto\ProjectSearchFilterParams;
use CiaFerias\Time\Exception\CustomerServiceException;
...
class CustomerDaoTest extends KernelTestCase
{
    ...
    {
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasTimePlugin/test/fixtures/CustomerService.yml';
        TestDataService::populate($this->fixture);
    }

    private function populateCustomerDaoFixture(): void
    {
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasTimePlugin/test/fixtures/CustomerDao.yaml';
        TestDataService::populate($this->fixture);
    }
