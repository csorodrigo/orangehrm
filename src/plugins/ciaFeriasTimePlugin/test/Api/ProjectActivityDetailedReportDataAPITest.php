...
namespace CiaFerias\Tests\Time\Api;
...
use CiaFerias\Time\Api\TimeReportDataAPI;
...
class ProjectActivityDetailedReportDataAPITest extends EndpointIntegrationTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        TestDataService::populate(
            ...
            '/ciaFeriasTimePlugin/test/fixtures/ProjectActivityDetailedReportDataAPITest.yaml',
            true
        );
    }
