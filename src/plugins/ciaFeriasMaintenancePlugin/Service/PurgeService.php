...
namespace CiaFerias\Maintenance\Service;
...
use CiaFerias\Maintenance\Event\MaintenanceEvent;
use CiaFerias\Maintenance\Event\PurgeEmployee;
use CiaFerias\Maintenance\PurgeStrategy\PurgeStrategy;
...
class PurgeService
{
    ...
    public function getPurgeStrategy(
        ...
        $purgeStrategyClass = 'CiaFerias\\Maintenance\\PurgeStrategy\\' . $strategy . 'PurgeStrategy';
