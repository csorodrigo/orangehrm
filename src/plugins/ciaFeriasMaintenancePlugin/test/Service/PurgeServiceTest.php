...
namespace CiaFerias\Tests\Maintenance\Service;
...
use CiaFerias\Entity\BuzzLikeOnShare;
use CiaFerias\Entity\BuzzLink;
use CiaFerias\Entity\BuzzPhoto;
use CiaFerias\Entity\BuzzPost;
use CiaFerias\Entity\BuzzShare;
use CiaFerias\Entity\Candidate;
use CiaFerias\Entity\CandidateAttachment;
use CiaFerias\Entity\CandidateHistory;
use CiaFerias\Entity\CandidateVacancy;
use CiaFerias\Entity\EmpContract;
use CiaFerias\Entity\EmpDependent;
use CiaFerias\Entity\EmpDirectDebit;
use CiaFerias\Entity\EmpEmergencyContact;
use CiaFerias\Entity\EmpLocations;
use CiaFerias\Entity\Employee;
use CiaFerias\Entity\EmployeeAttachment;
use CiaFerias\Entity\EmployeeEducation;
use CiaFerias\Entity\EmployeeImmigrationRecord;
use CiaFerias\Entity\EmployeeLanguage;
use CiaFerias\Entity\EmployeeLicense;
use CiaFerias\Entity\EmployeeMembership;
use CiaFerias\Entity\EmployeeSalary;
use CiaFerias\Entity\EmployeeSkill;
use CiaFerias\Entity\EmpPicture;
use CiaFerias\Entity\EmpUsTaxExemption;
use CiaFerias\Entity\EmpWorkExperience;
use CiaFerias\Entity\Interview;
use CiaFerias\Entity\InterviewAttachment;
use CiaFerias\Entity\InterviewInterviewer;
use CiaFerias\Entity\LeaveComment;
use CiaFerias\Entity\LeaveRequestComment;
use CiaFerias\Entity\PerformanceReview;
use CiaFerias\Entity\PerformanceTrackerLog;
use CiaFerias\Entity\ReportTo;
use CiaFerias\Entity\Reviewer;
use CiaFerias\Entity\ReviewerRating;
use CiaFerias\Entity\TimesheetItem;
use CiaFerias\Entity\User;
use CiaFerias\Framework\Services;
use CiaFerias\Maintenance\Dao\PurgeDao;
use CiaFerias\Maintenance\Dto\InfoArray;
use CiaFerias\Maintenance\PurgeStrategy\DestroyPurgeStrategy;
use CiaFerias\Maintenance\PurgeStrategy\ReplaceWithValuePurgeStrategy;
...
class PurgeServiceTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ) . '/ciaFeriasMaintenancePlugin/test/fixtures/PurgeService.yml';
