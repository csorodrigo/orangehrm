...
use CiaFerias\Maintenance\AccessStrategy\AccessStrategy;
use CiaFerias\Maintenance\Service\MaintenanceService;
...
class MaintenanceServiceTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR)
            . '/ciaFeriasMaintenancePlugin/test/fixtures/EmployeeMaintenence.yml';
    ...
    {
        $result = $this->maintenanceService->accessEmployeeData(1);
        $this->assertEquals('cia-ferias', $result['EmpWorkExperience'][0]['employer']);
