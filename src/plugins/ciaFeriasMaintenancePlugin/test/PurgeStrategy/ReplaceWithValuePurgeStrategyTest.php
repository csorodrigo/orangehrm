...
use CiaFerias\Maintenance\FormatValueStrategy\ValueFormatter;
use CiaFerias\Maintenance\PurgeStrategy\FormatValue\FormatWithEmptyString;
use CiaFerias\Maintenance\PurgeStrategy\FormatValue\FormatWithNull;
use CiaFerias\Maintenance\PurgeStrategy\FormatValue\FormatWithPurgeString;
use CiaFerias\Maintenance\PurgeStrategy\FormatValue\FormatWithPurgeTime;
use CiaFerias\Maintenance\PurgeStrategy\FormatValue\FormatWithZero;
...
class ReplaceWithValuePurgeStrategyTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ) . '/ciaFeriasMaintenancePlugin/test/fixtures/ReplaceWithValuePurgeStrategy.yml';
