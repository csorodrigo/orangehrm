...
use CiaFerias\Entity\Decorator\BuzzPhotoDecorator;
use CiaFerias\Entity\Decorator\DecoratorTrait;

/**
 * @method BuzzPhotoDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_buzz_photo")
 * @ORM\Entity
 */
class BuzzPhoto
{
     ...
     * @var BuzzPost
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\BuzzPost", inversedBy="photos")
