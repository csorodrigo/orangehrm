...
use CiaFerias\Entity\Decorator\BuzzPostDecorator;
use CiaFerias\Entity\Decorator\DecoratorTrait;

/**
 * @method BuzzPostDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_buzz_post")
 * @ORM\Entity
 */
class BuzzPost
{
     ...
     * @var BuzzPhoto[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\BuzzPhoto", mappedBy="post")
     */
     ...
     * @var BuzzLink[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\BuzzLink", mappedBy="post")
     */
