...
use CiaFerias\Entity\Decorator\BuzzLikeOnCommentDecorator;
 ...
 *
 * @ORM\Table(name="cia_ferias_buzz_like_on_comment")
 * @ORM\Entity
 */
class BuzzLikeOnComment
{
     ...
     * @var BuzzComment
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\BuzzComment")
