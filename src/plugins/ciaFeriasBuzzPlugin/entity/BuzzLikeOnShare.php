...
use CiaFerias\Entity\Decorator\BuzzLikeOnShareDecorator;
 ...
 *
 * @ORM\Table(name="cia_ferias_buzz_like_on_share")
 * @ORM\Entity
 */
class BuzzLikeOnShare
{
     ...
     * @var BuzzShare
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\BuzzShare")
