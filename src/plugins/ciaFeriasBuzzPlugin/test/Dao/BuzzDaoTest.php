...
class BuzzDaoTest extends KernelTestCase
{
    ...
    {
        $fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasBuzzPlugin/test/fixtures/BuzzDao.yaml';
    ...
    public function testSaveBuzzPhotos(): void
    {
        ...
        $photoPath = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasBuzzPlugin/test/fixtures/orange.png';
