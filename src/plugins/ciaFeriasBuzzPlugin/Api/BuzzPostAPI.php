...
use CiaFerias\Buzz\Api\Model\BuzzFeedPostModel;
use CiaFerias\Buzz\Api\Model\BuzzPostModel;
use CiaFerias\Buzz\Api\ValidationRules\BuzzVideoLinkValidationRule;
use CiaFerias\Buzz\Dto\BuzzFeedFilterParams;
use CiaFerias\Buzz\Dto\BuzzFeedPost;
...
class BuzzPostAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={CiaFerias\Buzz\Api\BuzzPostAPI::MODEL_DEFAULT_POST, CiaFerias\Buzz\Api\BuzzPostAPI::MODEL_DETAILED_POST},
     *             default=CiaFerias\Buzz\Api\BuzzPostAPI::MODEL_DEFAULT_POST
     *         )
     *     ),
     *     @OA\Response(response="200",
     *         description="Success",
