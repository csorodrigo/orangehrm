...
use CiaFerias\Pim\Api\Model\EmployeeWorkExperienceModel;
use CiaFerias\Pim\Dto\EmployeeWorkExperienceSearchFilterParams;
use CiaFerias\Pim\Service\EmployeeWorkExperienceService;
...
class EmployeeWorkExperienceAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="company",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeWorkExperienceAPI::PARAM_RULE_EMPLOYER_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="jobTitle",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeWorkExperienceAPI::PARAM_RULE_JOB_TITLE_MAX_LENGTH
     *             ),
     ...
     *                 property="comment",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeWorkExperienceAPI::PARAM_RULE_COMMENTS_MAX_LENGTH
     *             ),
