...
use CiaFerias\Pim\Api\Model\EmployeeImmigrationModel;
use CiaFerias\Pim\Dto\EmployeeImmigrationRecordSearchFilterParams;
use CiaFerias\Pim\Service\EmployeeImmigrationRecordService;
...
class EmployeeImmigrationRecordAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="number",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeImmigrationRecordAPI::PARAM_RULE_DEFAULT_MAX_LENGTH
     *             ),
     ...
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeImmigrationRecordAPI::PARAM_RULE_COUNTRY_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="comment",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeImmigrationRecordAPI::PARAM_RULE_COMMENT_MAX_LENGTH
     *             ),
