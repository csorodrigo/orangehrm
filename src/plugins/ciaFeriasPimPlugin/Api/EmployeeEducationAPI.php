...
use CiaFerias\Pim\Api\Model\EmployeeEducationModel;
use CiaFerias\Pim\Dto\EmployeeEducationSearchFilterParams;
use CiaFerias\Pim\Service\EmployeeEducationService;
...
class EmployeeEducationAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="institute",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeEducationAPI::PARAM_RULE_INSTITUTE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="major",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeEducationAPI::PARAM_RULE_MAJOR_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="year",
     *                 type="integer",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeEducationAPI::PARAM_RULE_YEAR_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="score",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeEducationAPI::PARAM_RULE_SCORE_MAX_LENGTH
     *             ),
