...
class EmployeeCountAPI extends Endpoint implements CollectionEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             maxLength=CiaFerias\Pim\Api\EmployeeAPI::PARAM_RULE_FILTER_NAME_OR_ID_MAX_LENGTH
     *         )
     *     ),
     *     @OA\Parameter(
     *         name="employeeId",
     ...
     *         in="query",
     *         required=false,
     *         @OA\Schema(type="string", enum=CiaFerias\Pim\Dto\EmployeeSearchFilterParams::INCLUDE_EMPLOYEES_MAP)
     *     ),
     *     @OA\Response(
     *         response="200",
     *         description="Success",
