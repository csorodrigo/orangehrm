...
use CiaFerias\Entity\TerminationReason;
use CiaFerias\Pim\Api\Model\TerminationReasonConfigurationModel;
use CiaFerias\Pim\Dto\TerminationReasonConfigurationSearchFilterParams;
use CiaFerias\Pim\Service\TerminationReasonConfigurationService;
...
class TerminationReasonConfigurationAPI extends EndPoint implements CrudEndpoint
{
     ...
     *                 property="name",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\TerminationReasonConfigurationAPI::PARAM_RULE_NAME_MAX_LENGTH
     *             ),
     *             required={"name"}
     *         )
     *     ),
