...
use CiaFerias\Pim\Api\Model\EmployeeAllowedReportToEmployeeModel;
...
class EmployeeAllowedReportToEmployeeAPI extends Endpoint implements CollectionEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             maxLength=CiaFerias\Pim\Api\EmployeeAllowedReportToEmployeeAPI::PARAM_RULE_FILTER_NAME_OR_ID_MAX_LENGTH
     *         )
     *     ),
     *     @OA\Parameter(
     *         name="sortField",
