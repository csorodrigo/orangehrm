...
use CiaFerias\Core\Exception\ServiceException;
use CiaFerias\Entity\EmpDependent;
use CiaFerias\Pim\Api\Model\EmployeeDependentModel;
use CiaFerias\Pim\Dto\EmployeeDependentSearchFilterParams;
use CiaFerias\Pim\Service\EmployeeDependentService;
...
class EmployeeDependentAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 description="Specify the name of the dependent",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeDependentAPI::PARAM_RULE_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="relationshipType",
     *                 description="Specify the relationship type",
     *                 type="string",
     *                 enum={CiaFerias\Entity\EmpDependent::RELATIONSHIP_TYPE_CHILD, CiaFerias\Entity\EmpDependent::RELATIONSHIP_TYPE_OTHER}
     *             ),
     *             @OA\Property(
     *                 property="relationship",
     *                 description="Specify additional details of the relationship",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeDependentAPI::PARAM_RULE_RELATIONSHIP_MAX_LENGTH
     *             ),
