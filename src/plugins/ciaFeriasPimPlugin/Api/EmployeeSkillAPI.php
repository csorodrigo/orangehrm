...
use CiaFerias\Pim\Api\Model\EmployeeSkillModel;
...
class EmployeeSkillAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 type="integer",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeSkillAPI::PARAM_RULE_YEARS_OF_EXP_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="comments",
     *                 description="Specify the comment regarding the skill",
     *                 type="string",
     *                 maxLength=CiaFerias\Pim\Api\EmployeeSkillAPI::PARAM_RULE_COMMENTS_MAX_LENGTH
     *             ),
