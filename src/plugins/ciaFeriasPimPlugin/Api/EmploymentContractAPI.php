...
use CiaFerias\Pim\Api\Model\EmploymentContractModel;
...
class EmploymentContractAPI extends Endpoint implements ResourceEndpoint
{
     ...
     *                 type="string",
     *                 enum={
     *                     CiaFerias\Pim\Api\EmploymentContractAPI::CONTRACT_ATTACHMENT_REPLACE_CURRENT,
     *                     CiaFerias\Pim\Api\EmploymentContractAPI::CONTRACT_ATTACHMENT_KEEP_CURRENT,
     *                     CiaFerias\Pim\Api\EmploymentContractAPI::CONTRACT_ATTACHMENT_DELETE_CURRENT
     *                 }
     *             ),
