...
namespace CiaFerias\Tests\Pim\Dao;

use DateTime;
use Exception;
use CiaFerias\Config\Config;
use CiaFerias\Entity\EmpWorkExperience;
use CiaFerias\Pim\Dao\EmployeeWorkExperienceDao;
...
class EmployeeWorkExperienceDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeWorkExperienceDao.yml';
    ...
    public function testGetEmployeeWorkExperienceById(): void
    {
        ...
        $this->assertEquals('cia-ferias', $result->getEmployer());
    ...
    public function testSaveEmployeeWorkExperience(): void
    {
        ...
        $employeeWorkExperience->setEmployer('CiaFerias');
        ...
        $this->assertEquals("CiaFerias", $result->getEmployer());
        $this->assertEquals("SE", $result->getJobTitle());
