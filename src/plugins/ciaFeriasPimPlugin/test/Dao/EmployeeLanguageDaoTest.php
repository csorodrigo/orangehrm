...
use CiaFerias\Pim\Dto\EmployeeAllowedLanguageSearchFilterParams;
...
class EmployeeLanguageDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeLanguageDao.yml';
