...
use CiaFerias\Pim\Dao\EmployeeLicenseDao;
use CiaFerias\Pim\Dto\EmployeeAllowedLicenseSearchFilterParams;
use CiaFerias\Pim\Dto\EmployeeLicenseSearchFilterParams;
...
class EmployeeLicenseDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeLicenseDao.yml';
