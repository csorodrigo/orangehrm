...
use CiaFerias\Core\Dto\DateRange;
use CiaFerias\Entity\Employee;
use CiaFerias\Entity\EmployeeEvent;
use CiaFerias\Pim\Dao\EmployeeEventDao;
use CiaFerias\Pim\Dto\EmployeeEventSearchFilterParams;
...
class EmployeeEventDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeEventDao.yml';
