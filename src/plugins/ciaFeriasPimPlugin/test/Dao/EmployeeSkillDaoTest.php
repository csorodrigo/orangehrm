...
use CiaFerias\Pim\Dto\EmployeeSkillSearchFilterParams;
use CiaFerias\Pim\Dto\EmployeeAllowedSkillSearchFilterParams;
...
class EmployeeSkillDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeSkillDao.yml';
