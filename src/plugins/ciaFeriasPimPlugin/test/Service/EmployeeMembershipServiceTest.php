...
use CiaFerias\Pim\Dto\EmployeeMembershipSearchFilterParams;
...
class EmployeeMembershipServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeMembershipDao.yml';
