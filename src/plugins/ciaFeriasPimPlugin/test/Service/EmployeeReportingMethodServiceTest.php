...
use CiaFerias\Pim\Dao\EmployeeReportingMethodDao;
use CiaFerias\Pim\Dto\EmployeeSubordinateSearchFilterParams;
use CiaFerias\Pim\Dto\EmployeeSupervisorSearchFilterParams;
use CiaFerias\Pim\Service\EmployeeReportingMethodService;
...
class EmployeeReportingMethodServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeReportingMethodDao.yml';
