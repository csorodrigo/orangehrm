...
use CiaFerias\Pim\Dao\TerminationReasonConfigurationDao;
...
class TerminationReasonConfigurationServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasPimPlugin/test/fixtures/TerminationReasonConfigurationDao.yml';
