...
namespace CiaFerias\Tests\Pim\Api;
...
use CiaFerias\Entity\Decorator\EmpContractDecorator;
...
use CiaFerias\Pim\Api\EmploymentContractAPI;
use CiaFerias\Pim\Dao\EmploymentContractDao;
use CiaFerias\Pim\Dto\PartialEmployeeAttachment;
use CiaFerias\Pim\Service\EmploymentContractService;
...
class EmploymentContractAPITest extends EndpointTestCase
{
    ...
    public function testGetValidationRuleForGetOne(): void
    {
        ...
        $authUser = $this->getMockBuilder(\CiaFerias\Authentication\Auth\User::class)
