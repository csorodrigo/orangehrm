...
use CiaFerias\Entity\Language;
use CiaFerias\Framework\Services;
use CiaFerias\Pim\Api\EmployeeLanguageAPI;
use CiaFerias\Pim\Dao\EmployeeLanguageDao;
...
class EmployeeLanguageAPITest extends EndpointTestCase
{
    protected function loadFixtures(): void
    {
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeLanguageDao.yml';
