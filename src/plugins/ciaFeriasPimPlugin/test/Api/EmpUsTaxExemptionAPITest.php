...
use CiaFerias\Entity\Province;
use CiaFerias\Framework\Services;
use CiaFerias\Pim\Api\EmpUsTaxExemptionAPI;
use CiaFerias\Pim\Dao\EmpUsTaxExemptionDao;
use CiaFerias\Pim\Service\EmpUsTaxExemptionService;
...
class EmpUsTaxExemptionAPITest extends EndpointTestCase
{
    protected function loadFixtures(): void
    {
        $this->fixture = Config::get(Config::PLUGINS_DIR) .
            '/ciaFeriasPimPlugin/test/fixtures/EmpUsTaxExemptionDao.yml';
