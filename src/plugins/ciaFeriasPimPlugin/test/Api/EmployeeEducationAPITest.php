...
use CiaFerias\Entity\Education;
use CiaFerias\Entity\Employee;
use CiaFerias\Entity\EmployeeEducation;
use CiaFerias\Framework\Services;
use CiaFerias\Pim\Api\EmployeeEducationAPI;
use CiaFerias\Pim\Dao\EmployeeEducationDao;
...
class EmployeeEducationAPITest extends EndpointTestCase
{
    protected function loadFixtures(): void
    {
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeEducationDao.yml';
