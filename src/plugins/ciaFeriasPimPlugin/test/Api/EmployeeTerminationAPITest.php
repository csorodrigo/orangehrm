...
use CiaFerias\Pim\Api\EmployeeTerminationAPI;
use CiaFerias\Pim\Dao\EmployeeTerminationDao;
use CiaFerias\Pim\Service\EmployeeService;
use CiaFerias\Pim\Service\EmployeeTerminationService;
...
class EmployeeTerminationAPITest extends EndpointTestCase
{
    protected function loadFixtures(): void
    {
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeTerminationDao.yml';
