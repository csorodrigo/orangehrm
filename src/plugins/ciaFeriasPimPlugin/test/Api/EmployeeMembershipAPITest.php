...
use CiaFerias\Entity\CurrencyType;
use CiaFerias\Entity\Employee;
use CiaFerias\Entity\EmployeeMembership;
use CiaFerias\Entity\Membership;
use CiaFerias\Framework\Services;
use CiaFerias\Pim\Api\EmployeeMembershipAPI;
use CiaFerias\Pim\Dao\EmployeeMembershipDao;
use CiaFerias\Pim\Service\EmployeeMembershipService;
...
class EmployeeMembershipAPITest extends EndpointTestCase
{
    protected function loadFixtures(): void
    {
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ) . '/ciaFeriasPimPlugin/test/fixtures/EmployeeMembershipDao.yml';
