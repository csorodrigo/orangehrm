...
use CiaFerias\Entity\Decorator\EmployeeSalaryDecorator;
 ...
 * @ORM\Entity
 * @ORM\EntityListeners({"CiaFerias\Entity\Listener\EmployeeSalaryListener"})
 */
class EmployeeSalary
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="salaries", cascade={"persist"})
     ...
     * @var PayGrade|null
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\PayGrade")
     ...
     * @var CurrencyType
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\CurrencyType")
     ...
     * @var PayPeriod|null
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\PayPeriod")
     ...
     *
     * @ORM\OneToOne(targetEntity="CiaFerias\Entity\EmpDirectDebit", mappedBy="salary", cascade={"persist"})
     */
