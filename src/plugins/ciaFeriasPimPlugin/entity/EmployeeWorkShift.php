...
/**
 * @ORM\Table(name="cia_ferias_employee_work_shift")
 * @ORM\Entity
 */
class EmployeeWorkShift
{
     ...
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\WorkShift")
     ...
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="NONE")
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="employeeWorkShift")
