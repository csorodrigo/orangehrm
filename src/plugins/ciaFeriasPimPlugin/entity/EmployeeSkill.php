...
use CiaFerias\Entity\Decorator\EmployeeSkillDecorator;
...
class EmployeeSkill
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="skills", cascade={"persist"})
     * @ORM\Id
     ...
     * @var Skill
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Skill", inversedBy="employeeSkills")
     * @ORM\Id
