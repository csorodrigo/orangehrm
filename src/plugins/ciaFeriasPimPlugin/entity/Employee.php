...
use CiaFerias\Entity\Decorator\EmployeeDecorator;
 ...
 * @ORM\Entity
 * @ORM\EntityListeners({"CiaFerias\Entity\Listener\EmployeeListener"})
 */
class Employee
{
    use DecoratorTrait;
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Nationality")
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\EmploymentStatus", inversedBy="employees")
     ...
     * @var JobTitle|null
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\JobTitle", inversedBy="employees")
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\JobCategory")
     ...
     * @var Subunit|null
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Subunit")
     ...
     *
     * @ORM\OneToOne(targetEntity="CiaFerias\Entity\EmployeeTerminationRecord", cascade={"persist"})
     ...
     * @var Location[]
     *
     * @ORM\ManyToMany(targetEntity="CiaFerias\Entity\Location", inversedBy="employees")
     * @ORM\JoinTable(
     ...
     * @var EmpDependent[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmpDependent", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmpEmergencyContact", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmployeeImmigrationRecord", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmpWorkExperience", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmployeeEducation", mappedBy="employee")
     */
     ...
     * @var EmployeeSkill[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmployeeSkill", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmployeeLanguage", mappedBy="employee")
     */
     ...
     * @var EmployeeLicense[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmployeeLicense", mappedBy="employee")
     */
     ...
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmployeeMembership", mappedBy="employee")
     */
     ...
     * @var EmployeeSalary[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmployeeSalary", mappedBy="employee")
     */
     ...
     * @var EmpContract[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmpContract", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmployeeAttachment", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\EmployeeTerminationRecord", mappedBy="employee")
     */
     ...
     * @var User[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\User", mappedBy="employee")
     */
     ...
     * @var EmpPicture|null
     *
     * @ORM\OneToOne(targetEntity="CiaFerias\Entity\EmpPicture", mappedBy="employee")
     */
     ...
     * @var Employee[]
     *
     * @ORM\ManyToMany(targetEntity="CiaFerias\Entity\Employee", mappedBy="supervisors")
     */
     ...
     * @var Employee[]
     *
     * @ORM\ManyToMany(targetEntity="CiaFerias\Entity\Employee", inversedBy="subordinates")
     * @ORM\JoinTable(
     ...
     *
     * @ORM\OneToOne(targetEntity="CiaFerias\Entity\EmpUsTaxExemption", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToOne(targetEntity="CiaFerias\Entity\EmployeeWorkShift", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\AttendanceRecord", mappedBy="employee")
     */
