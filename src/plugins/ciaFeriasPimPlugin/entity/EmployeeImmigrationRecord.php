...
use CiaFerias\Entity\Decorator\EmployeeImmigrationRecordDecorator;
...
class EmployeeImmigrationRecord
{
     ...
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="immigrationRecords", cascade={"persist"})
