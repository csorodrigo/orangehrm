...
use CiaFerias\Entity\Decorator\EmpEmergencyContactDecorator;
...
class EmpEmergencyContact
{
     ...
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="emergencyContacts", cascade={"persist"})
