...
use CiaFerias\Entity\Decorator\EmpWorkExperienceDecorator;
...
class EmpWorkExperience
{
     ...
     * @var Employee
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="workExperience", cascade={"persist"})
