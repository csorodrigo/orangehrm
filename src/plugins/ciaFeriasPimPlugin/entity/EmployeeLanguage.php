...
use CiaFerias\Entity\Decorator\EmployeeLanguageDecorator;
...
class EmployeeLanguage
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="languages", cascade={"persist"})
     * @ORM\Id
     ...
     * @var Language
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Language", inversedBy="employeeLanguages")
     * @ORM\Id
