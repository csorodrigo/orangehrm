...
use CiaFerias\Entity\Decorator\EmployeeEducationDecorator;

/**
 * @method EmployeeEducationDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_emp_education")
 * @ORM\Entity
 */
class EmployeeEducation
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="educations", cascade={"persist"})
     ...
     * @var Education
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Education", inversedBy="employeeEducation")
