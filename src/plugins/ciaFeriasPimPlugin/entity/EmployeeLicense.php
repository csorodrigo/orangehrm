...
use CiaFerias\Entity\Decorator\EmployeeLicenseDecorator;

/**
 * @method EmployeeLicenseDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_emp_license")
 * @ORM\Entity
 */
class EmployeeLicense
{
     ...
     * @var License
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\License", inversedBy="employeeLicenses")
     * @ORM\Id
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="licenses", cascade={"persist"})
     * @ORM\Id
