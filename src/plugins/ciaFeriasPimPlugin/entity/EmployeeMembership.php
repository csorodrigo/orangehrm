...
use CiaFerias\Entity\Decorator\EmployeeMembershipDecorator;
...
class EmployeeMembership
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="memberships", cascade={"persist"})
     ...
     * @var Membership
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Membership")
