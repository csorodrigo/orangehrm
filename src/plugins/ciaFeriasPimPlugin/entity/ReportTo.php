...
use CiaFerias\Entity\Decorator\ReportToDecorator;
...
class ReportTo
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", cascade={"persist"})
     ...
     * @var ReportingMethod
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\ReportingMethod", inversedBy="reportTos", cascade={"persist"})
