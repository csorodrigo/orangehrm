...
namespace CiaFerias\Tests\Core\Import;

use DateTime;
use CiaFerias\Admin\Dao\CountryDao;
use CiaFerias\Admin\Service\CountryService;
use CiaFerias\Admin\Service\NationalityService;
use CiaFerias\Core\Import\PimCsvDataImport;
...
class PimCsvDataImportTest extends KernelTestCase
{
    ...
    public function testImportWhenSuccessful(): void
    {
        $data = [
            ...
            "",
            "213-926-2007",
            "yasiru@ciaferias.local",
            "yasirun@ciaferias.local"
        ];
        ...
        $employee->setWorkEmail('yasiru@ciaferias.local');
        $employee->setOtherEmail('yasirun@ciaferias.local');
