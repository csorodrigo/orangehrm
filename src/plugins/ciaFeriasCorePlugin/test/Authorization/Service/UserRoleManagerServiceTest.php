...
namespace CiaFerias\Tests\Core\Authorization\Service;
...
use CiaFerias\Core\Authorization\Service\UserRoleManagerService;
use CiaFerias\Core\Dao\ConfigDao;
...
class UserRoleManagerServiceTest extends KernelTestCase
{
    ...
    public function testGetUserRoleManagerInvalidClass(): void
    {
        ...
        try {
            ...
            $this->assertEquals(
                'User Role Manager class CiaFerias\Tests\Core\Authorization\Service\InvalidUserRoleManager is not a subclass of CiaFerias\Core\Authorization\Manager\AbstractUserRoleManager',
                $e->getMessage()
            );
        }
    }
