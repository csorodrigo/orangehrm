...
namespace CiaFerias\Tests\Core\Authorization\Manager;
...
use CiaFerias\Entity\HomePage;
use CiaFerias\Entity\Location;
use CiaFerias\Entity\Module;
use CiaFerias\Entity\ModuleDefaultPage;
use CiaFerias\Entity\Project;
use CiaFerias\Entity\ProjectAdmin;
...
class BasicUserRoleManagerTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ) . '/ciaFeriasCorePlugin/test/fixtures/BasicUserRoleManager.yml';
