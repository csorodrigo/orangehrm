...
namespace CiaFerias\Tests\Core\Dao;

use CiaFerias\Config\Config;
use CiaFerias\Core\Dao\AccessFlowStateMachineDao;
...
class AccessFlowStateMachineDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        TestDataService::populate(
            Config::get(Config::PLUGINS_DIR) . '/ciaFeriasCorePlugin/test/fixtures/AccessFlowStateMachineDao.yml'
        );
    }
    ...
    protected function getWorkflowItemIdsForRole(string $flow, string $role): array
    {
        ...
        $query = "SELECT id from cia_ferias_workflow_state_machine WHERE workflow = ? AND role = ?";
