...
namespace CiaFerias\Tests\Core\Helper;
...
class ClassHelperTest extends TestCase
{
    public function testGetClass(): void
    {
        ...
        $className = $classHelper->getClass('ClassHelperTestClass', 'CiaFerias\\Tests\\Core\\Helper\\');
        $this->assertEquals('CiaFerias\\Tests\\Core\\Helper\\ClassHelperTestClass', $className);

        $className = $classHelper->getClass('CiaFerias\\Tests\\Core\\Helper\\ClassHelperTestClass');
        $this->assertEquals('CiaFerias\\Tests\\Core\\Helper\\ClassHelperTestClass', $className);

        $className = $classHelper->getClass('ClassHelperTestClass');
        $this->assertNull($className);

        $className = $classHelper->getClass('ClassHelperTestClass_Test', 'CiaFerias\\Tests\\Core\\Helper\\');
        $this->assertNull($className);
    }
    ...
    {
        $classHelper = new ClassHelper();
        $classExists = $classHelper->classExists('ClassHelperTestClass', 'CiaFerias\\Tests\\Core\\Helper\\');
        $this->assertTrue($classExists);

        $classExists = $classHelper->classExists('CiaFerias\\Tests\\Core\\Helper\\ClassHelperTestClass');
        $this->assertTrue($classExists);

        $classExists = $classHelper->classExists('ClassHelperTestClass');
        $this->assertFalse($classExists);

        $classExists = $classHelper->classExists('ClassHelperTestClass_Test', 'CiaFerias\\Tests\\Core\\Helper\\');
        $this->assertFalse($classExists);
    }
