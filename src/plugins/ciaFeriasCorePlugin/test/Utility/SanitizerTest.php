...
class SanitizerTest extends TestCase
{
    ...
    public function testSanitizeSVGWithRegularSVG(): void
    {
        ...
        $sanitizedSVG = $this->sanitizer->sanitizeSvg($ciaFeriasLogoSVG);

        $this->assertXmlStringEqualsXmlString($sanitizedSVG, $ciaFeriasLogoSVG);
    }
