...
namespace CiaFerias\Core\Report\DisplayField;
...
class GenericDateDisplayField extends CombinedDisplayField
{
    ...
    /**
     * @param \CiaFerias\Entity\DisplayField $displayField
     */
    public function setDisplayField(\CiaFerias\Entity\DisplayField $displayField): void
    {
