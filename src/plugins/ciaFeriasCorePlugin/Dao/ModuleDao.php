...
use CiaFerias\Core\Event\ModuleEvent;
use CiaFerias\Core\Event\ModuleStatusChange;
...
/**
 * Module Dao: Manages module entries in cia_ferias_module
 *
 */
class ModuleDao extends BaseDao
{
    ...
    /**
     * Get Module object collection from cia_ferias_module table
     * @return Module[]
     */
