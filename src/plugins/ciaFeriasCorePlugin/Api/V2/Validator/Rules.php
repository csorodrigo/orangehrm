...
namespace CiaFerias\Core\Api\V2\Validator;

use CiaFerias\Core\Api\V2\Validator\Rules as CiaFeriasRules;
use Respect\Validation\Rules as RespectRules;

final class Rules
{
    public const ALL_OF = CiaFeriasRules\Composite\AllOf::class;
    public const ANY_OF = CiaFeriasRules\Composite\AnyOf::class;
    public const NONE_OF = CiaFeriasRules\Composite\NoneOf::class;
    public const ONE_OF = CiaFeriasRules\Composite\OneOf::class;

    public const REQUIRED = CiaFeriasRules\Required::class;
    public const NOT_REQUIRED = CiaFeriasRules\NotRequired::class;
    public const ZERO_OR_POSITIVE = CiaFeriasRules\ZeroOrPositive::class;
    public const IN_ACCESSIBLE_EMP_NUMBERS = CiaFeriasRules\InAccessibleEmpNumbers::class;
    public const BASE_64_ATTACHMENT = CiaFeriasRules\Base64Attachment::class;
    public const COUNTRY_CODE = CiaFeriasRules\CountryCode::class;
    public const PROVINCE_CODE = CiaFeriasRules\ProvinceCode::class;
    public const CURRENCY = CiaFeriasRules\Currency::class;
    public const API_DATE = CiaFeriasRules\ApiDate::class;
    public const EACH = CiaFeriasRules\Each::class;
    public const NOT_IN = CiaFeriasRules\NotIn::class;
    public const LESS_THAN_OR_EQUAL = CiaFeriasRules\LessThanOrEqual::class;
    public const ENTITY_ID_EXISTS = CiaFeriasRules\EntityIdExists::class;
    public const ENTITY_UNIQUE_PROPERTY = CiaFeriasRules\EntityUniqueProperty::class;
    public const IN_ACCESSIBLE_ENTITY_ID = CiaFeriasRules\InAccessibleEntityId::class;
    public const TIMEZONE_OFFSET = CiaFeriasRules\TimezoneOffset::class;
    public const TIMEZONE_NAME = CiaFeriasRules\TimezoneName::class;
    public const EMAIL = CiaFeriasRules\Email::class;
    public const PHONE = CiaFeriasRules\Phone::class;
    public const PASSWORD = CiaFeriasRules\Password::class;
    public const INT_ARRAY = CiaFeriasRules\IntArray::class;
    public const STR_LENGTH = CiaFeriasRules\StrLength::class;
    public const STRING_TYPE = CiaFeriasRules\NotBlankStringType::class;
