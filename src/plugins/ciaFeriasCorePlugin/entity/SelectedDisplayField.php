...
use CiaFerias\Entity\Decorator\SelectedDisplayFieldDecorator;

/**
 * @method SelectedDisplayFieldDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_selected_display_field")
 * @ORM\Entity
 */
class SelectedDisplayField
{
     ...
     * @var DisplayField
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\DisplayField", inversedBy="selectedDisplayFields")
