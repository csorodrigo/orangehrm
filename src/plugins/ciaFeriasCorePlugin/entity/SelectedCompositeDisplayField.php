...
/**
 * @ORM\Table(name="cia_ferias_selected_composite_display_field")
 * @ORM\Entity
 */
class SelectedCompositeDisplayField
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\CompositeDisplayField", inversedBy="selectedCompositeDisplayFields")
