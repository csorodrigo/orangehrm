...
/**
 * @ORM\Table(name="cia_ferias_api_permission", uniqueConstraints={@ORM\UniqueConstraint(name="api_name", columns={"api_name"})})
 * @ORM\Entity
 */
class ApiPermission
{
     ...
     * @var Module
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Module")
     ...
     * @var DataGroup
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\DataGroup", inversedBy="apiPermissions")
