...
/**
 * @ORM\Table(name="cia_ferias_summary_display_field")
 * @ORM\Entity
 */
class SummaryDisplayField
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\DisplayFieldGroup")
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\SelectedGroupField", mappedBy="summaryDisplayField")
     */
