...
/**
 * @ORM\Table(name="cia_ferias_composite_display_field")
 * @ORM\Entity
 */
class CompositeDisplayField extends AbstractDisplayField
{
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\SelectedCompositeDisplayField", mappedBy="compositeDisplayField")
     */
