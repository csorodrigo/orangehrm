...
/**
 * @ORM\Table(name="cia_ferias_selected_group_field")
 * @ORM\Entity
 */
class SelectedGroupField
{
     ...
     * @var GroupField
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\GroupField")
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\SummaryDisplayField", inversedBy="selectedGroupFields")
