...
/**
 * @ORM\Table(name="cia_ferias_data_group")
 * @ORM\Entity
 */
class DataGroup
{
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\DataGroupPermission", mappedBy="dataGroup")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\ApiPermission", mappedBy="dataGroup")
     */
