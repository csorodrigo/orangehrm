...
/**
 * @ORM\Table(name="cia_ferias_user_role_data_group")
 * @ORM\Entity
 */
class DataGroupPermission
{
     ...
     * @var DataGroup
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\DataGroup", inversedBy="dataGroupPermissions")
     ...
     * @var UserRole
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\UserRole", cascade={"persist"})
