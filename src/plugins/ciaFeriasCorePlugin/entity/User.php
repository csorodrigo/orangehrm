...
use CiaFerias\Entity\Decorator\UserDecorator;

/**
 * @method UserDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_user")
 * @ORM\Entity
 */
class User
{
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="users")
     ...
     * @var UserRole
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\UserRole")
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\UserAuthProvider", mappedBy="user")
     */
