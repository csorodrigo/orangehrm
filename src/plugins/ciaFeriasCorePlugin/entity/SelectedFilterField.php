...
use CiaFerias\Entity\Decorator\SelectedFilterFieldDecorator;

/**
 * @method SelectedFilterFieldDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_selected_filter_field")
 * @ORM\Entity
 */
class SelectedFilterField
{
     ...
     * @var FilterField
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\FilterField", inversedBy="selectedFilterFields")
