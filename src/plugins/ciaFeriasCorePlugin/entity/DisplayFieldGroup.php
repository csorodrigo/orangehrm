...
/**
 * @ORM\Table(name="cia_ferias_display_field_group")
 * @ORM\Entity
 */
class DisplayFieldGroup
{
     ...
     * @var ReportGroup
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\ReportGroup")
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\SelectedDisplayFieldGroup", mappedBy="displayFieldGroup")
     */
