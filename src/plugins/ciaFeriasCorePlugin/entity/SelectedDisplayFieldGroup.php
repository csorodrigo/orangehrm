...
use CiaFerias\Entity\Decorator\SelectedDisplayFieldGroupDecorator;

/**
 * @method SelectedDisplayFieldGroupDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_selected_display_field_group")
 * @ORM\Entity
 */
class SelectedDisplayFieldGroup
{
     ...
     * @var Report
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Report")
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\DisplayFieldGroup", inversedBy="selectedDisplayFieldGroups")
