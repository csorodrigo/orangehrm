...
use CiaFerias\Core\Dao\EmailDao;
use CiaFerias\Core\Exception\CoreServiceException;
use CiaFerias\Core\Exception\ServiceException as Exception;
use CiaFerias\Core\Mail\AbstractRecipient;
use CiaFerias\Core\Mail\MailProcessor;
use CiaFerias\Core\Mail\TemplateHelper;
use CiaFerias\Core\Traits\Auth\AuthUserTrait;
use CiaFerias\Core\Traits\CacheTrait;
...
use CiaFerias\Entity\EmailTemplate;
use CiaFerias\Framework\Event\Event;
...
class EmailService
{
    ...
    public function getMessage()
    {
        ...
        if (empty($this->messageFrom)) {
            ...
            $this->messageFrom = [$this->getEmailConfig()->getSentAs() => "cia-ferias"];
        }
    ...
    public function sendTestEmail(string $toEmail): bool
    {
        ...
        $body = "This email confirms that $type details set in cia-ferias ";
