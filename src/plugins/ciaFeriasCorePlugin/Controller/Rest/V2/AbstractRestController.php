...
namespace CiaFerias\Core\Controller\Rest\V2;
...
use CiaFerias\Core\Api\V2\Validator\Validator;
...
use CiaFerias\Framework\Http\Response as HttpResponse;
...
abstract class AbstractRestController extends AbstractController
{
    ...
    public function handle(HttpRequest $httpRequest): HttpResponse
    {
        ...
        try {
            ...
            // \CiaFerias\Core\Subscriber\ApiAuthorizationSubscriber::onExceptionEvent
            throw $e;
        } catch (Exception $e) {
