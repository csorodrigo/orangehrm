 ...
 * )
 * @OA\Info(
 *     title="CIA Férias : REST API v2 docs",
 *     version=\CiaFerias\Config\Config::CIA_FERIAS_API_VERSION,
 * )
 * @OA\Server(
 *     url="{cia-ferias-url}",
 *     variables={
 *         @OA\ServerVariable(
 *             serverVariable="cia-ferias-url",
 *             default="localhost:8081/web/index.php"
 *         )
 *     }
 * )
 *
