...
namespace CiaFerias\OpenidAuthentication\Controller;

use Exception;
use CiaFerias\Authentication\Auth\User as AuthUser;
use CiaFerias\Authentication\Controller\Traits\SessionHandlingTrait;
...
use CiaFerias\Core\Exception\RedirectableException;
