...
namespace CiaFerias\Tests\OpenidAuthentication\Dao;
...
class AuthProviderDaoTest extends KernelTestCase
{
    ...
    {
        $fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasOpenidAuthenticationPlugin/test/fixtures/AuthProviderDao.yml';
