...
use CiaFerias\LDAP\Api\Traits\LDAPCommonParamRuleCollection;
use CiaFerias\LDAP\Dto\LDAPSetting;
use CiaFerias\LDAP\Dto\LDAPUserLookupSetting;
use CiaFerias\LDAP\Service\LDAPTestService;
use CiaFerias\LDAP\Service\LDAPTestSyncService;
use CiaFerias\LDAP\Traits\LDAPLoggerTrait;
...
class LDAPTestConnectionAPI extends Endpoint implements CollectionEndpoint
{
     ...
     *                 property="hostname",
     *                 type="string",
     *                 maxLength=CiaFerias\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_HOST_NAME_MAX_LENGTH
     *             ),
     ...
     *                 type="string",
     *                 enum={
     *                     CiaFerias\LDAP\Api\LDAPConfigAPI::ENCRYPTION_NONE,
     *                     CiaFerias\LDAP\Api\LDAPConfigAPI::ENCRYPTION_TLS,
     *                     CiaFerias\LDAP\Api\LDAPConfigAPI::ENCRYPTION_SSL
     *                 }
     *             ),
     *             @OA\Property(
     ...
     *                 type="string",
     *                 enum={
     *                     CiaFerias\LDAP\Api\LDAPConfigAPI::LDAP_IMPLEMENTATION_OPEN_LDAP,
     *                     CiaFerias\LDAP\Api\LDAPConfigAPI::LDAP_IMPLEMENTATION_ACTIVE_DIRECTORY,
     *                 }
     *             ),
     ...
     *                 property="bindUserDN",
     *                 type="string",
     *                 maxLength=CiaFerias\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_BIND_USER_DISTINGUISHED_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="bindUserPassword",
     *                 type="string",
     *                 maxLength=CiaFerias\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_BIND_USER_PASSWORD_MAX_LENGTH
     *             ),
     ...
     *                         property="baseDN",
     *                         type="string",
     *                         maxLength=CiaFerias\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_BASE_DISTINGUISHED_NAME_MAX_LENGTH
     *                     ),
     ...
     *                         type="string",
     *                         maxLength=CiaFerias\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_USER_SEARCH_FILTER_MAX_LENGTH
     *                     ),
     ...
     *                     property="firstName",
     *                     type="string",
     *                     maxLength=CiaFerias\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_ATTRIBUTE_MAX_LENGTH
     *                 ),
     *                 @OA\Property(
     *                     property="middleName",
     *                     type="string",
