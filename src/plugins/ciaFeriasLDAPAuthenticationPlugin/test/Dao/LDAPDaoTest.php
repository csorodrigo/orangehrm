...
namespace CiaFerias\Tests\LDAP\Dao;
...
class LDAPDaoTest extends KernelTestCase
{
    protected function setUp(): void
    {
        $fixture = Config::get(Config::PLUGINS_DIR) .
            '/ciaFeriasLDAPAuthenticationPlugin/test/fixtures/LDAPDao.yaml';
    ...
    public function testGetEmployee(): void
    {
        ...
        try {
            ...
            $this->assertEquals(
                'At least one parameter should define in CiaFerias\LDAP\Dto\LDAPEmployeeSearchFilterParams',
                $e->getMessage()
            );
        }
