...
namespace CiaFerias\Tests\LDAP\Service;
...
use CiaFerias\LDAP\Dto\LDAPUserDataMapping;
use CiaFerias\LDAP\Dto\LDAPUserLookupSetting;
use CiaFerias\LDAP\Service\LDAPSyncService;
use CiaFerias\Pim\Service\EmployeeService;
use CiaFerias\Tests\Util\KernelTestCase;
use CiaFerias\Tests\Util\Mock\MockLogger;
...
class LDAPSyncServiceDeleteUsersTest extends KernelTestCase
{
    ...
    {
        $this->fixtureDir = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasLDAPAuthenticationPlugin/test/fixtures';
    }
