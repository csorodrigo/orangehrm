...
namespace CiaFerias\Tests\OAuth\Dao;

use CiaFerias\Config\Config;
use CiaFerias\Core\Traits\ORM\EntityManagerTrait;
use CiaFerias\Entity\OAuthClient;
use CiaFerias\OAuth\Dao\OAuthClientDao;
use CiaFerias\OAuth\Dto\OAuthClientSearchFilterParams;
...
class OAuthClientDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ) . '/ciaFeriasCoreOAuthPlugin/test/fixtures/OAuthClient.yml';
    ...
    public function testGetOAuthClientList(): void
    {
        ...
        $this->assertEquals("cia-ferias-mobile-updated", $clientList[0]->getName());
        ...
        $this->assertEquals("cia-ferias-mobile-2", $clientList[1]->getName());
    ...
    public function testGetOAuthClientById(): void
    {
        ...
        $this->assertEquals("cia-ferias-mobile-updated", $client->getName());
    ...
    public function testDeleteOAuthClients(): void
    {
        ...
        $this->assertEquals("cia-ferias-mobile-2", $clients[0]->getName());
    }
}
