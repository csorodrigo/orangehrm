...
use CiaFerias\Entity\OAuthAuthorizationCode;
use CiaFerias\Framework\Services;
use CiaFerias\OAuth\Dto\Entity\AuthCodeEntity;
use CiaFerias\OAuth\Dto\Entity\ClientEntity;
use CiaFerias\OAuth\Repository\AuthorizationCodeRepository;
...
class AuthorizationCodeRepositoryTest extends KernelTestCase
{
    protected function setUp(): void
    {
        $fixture = Config::get(Config::PLUGINS_DIR)
            . '/ciaFeriasCoreOAuthPlugin/test/fixtures/AuthorizationCodeRepositoryTest.yaml';
    ...
    public function testGetNewAuthCode(): void
    {
        ...
        $this->expectExceptionMessage(
            'Typed property CiaFerias\OAuth\Dto\Entity\AuthCodeEntity::$identifier must not be accessed before initialization'
        );
    ...
    public function testPersistNewAuthCode(): void
    {
        ...
        $clientEntity = new ClientEntity(
            ...
            'com.ciaferias.opensource://oauthCallback',
            false,
            'Mobile App'
        );
        ...
        $authCodeEntity->setRedirectUri('com.ciaferias.opensource://oauthCallback');
        $authorizationCodeRepository = new AuthorizationCodeRepository();
