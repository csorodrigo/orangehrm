...
use CiaFerias\Entity\OAuthRefreshToken;
use CiaFerias\Framework\Services;
use CiaFerias\OAuth\Dto\Entity\AccessTokenEntity;
use CiaFerias\OAuth\Dto\Entity\ClientEntity;
use CiaFerias\OAuth\Dto\Entity\RefreshTokenEntity;
use CiaFerias\OAuth\Repository\RefreshTokenRepository;
...
class RefreshTokenRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        $fixture = Config::get(Config::PLUGINS_DIR)
            . '/ciaFeriasCoreOAuthPlugin/test/fixtures/RefreshTokenRepositoryTest.yaml';
