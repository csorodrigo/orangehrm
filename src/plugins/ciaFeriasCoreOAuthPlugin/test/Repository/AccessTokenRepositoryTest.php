...
class AccessTokenRepositoryTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        $fixture = Config::get(Config::PLUGINS_DIR)
            . '/ciaFeriasCoreOAuthPlugin/test/fixtures/AccessTokenRepositoryTest.yaml';
    ...
    public function testGetNewTokenAndCallGetExpiryDateTime(): void
    {
        ...
        $this->expectExceptionMessage(
            'Typed property CiaFerias\OAuth\Dto\Entity\AccessTokenEntity::$expiryDateTime must not be accessed before initialization'
        );
    ...
    public function testGetNewTokenAndCallGetIdentifier(): void
    {
        ...
        $this->expectException(Error::class);
        $this->expectExceptionMessage(
            'Typed property CiaFerias\OAuth\Dto\Entity\AccessTokenEntity::$identifier must not be accessed before initialization'
        );
        $token->getIdentifier();
    }
