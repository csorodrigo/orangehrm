...
namespace CiaFerias\CorporateBranding\Service;

use CiaFerias\Config\Config;
use CiaFerias\Core\Traits\CacheTrait;
use CiaFerias\Core\Traits\ETagHelperTrait;
use CiaFerias\CorporateBranding\Dao\ThemeDao;
use CiaFerias\CorporateBranding\Dto\PartialTheme;
use CiaFerias\CorporateBranding\Dto\ThemeImage;
use CiaFerias\CorporateBranding\Dto\ThemeVariables;
...
class ThemeService
{
    ...
    public function getClientLogoURL(Request $request): string
    {
        ...
        return $request->getBasePath() . "/images/cia-ferias-logo.svg?v=$assetsVersion";
    }
    ...
    public function getClientBannerURL(Request $request): string
    {
        ...
        return $request->getBasePath() . "/images/cia-ferias-banner.svg?v=$assetsVersion";
    }
    ...
    public function getLoginBannerURL(Request $request): string
    {
        ...
        return $request->getBasePath() . "/images/cia-ferias-brand.svg?v=$assetsVersion";
    }
}
