...
namespace CiaFerias\CorporateBranding\Api;
...
use CiaFerias\CorporateBranding\Api\Model\ThemeModel;
use CiaFerias\CorporateBranding\Api\Traits\VariablesParamRuleCollection;
use CiaFerias\CorporateBranding\Api\ValidationRules\ImageAspectRatio;
use CiaFerias\CorporateBranding\Dto\PartialTheme;
use CiaFerias\CorporateBranding\Service\ThemeService;
use CiaFerias\CorporateBranding\Traits\ThemeServiceTrait;
...
class ThemeAPI extends Endpoint implements ResourceEndpoint
{
     ...
     *                 nullable=true,
     *                 enum={
     *                     CiaFerias\CorporateBranding\Api\ThemeAPI::KEEP_CURRENT,
     *                     CiaFerias\CorporateBranding\Api\ThemeAPI::DELETE_CURRENT,
     *                     CiaFerias\CorporateBranding\Api\ThemeAPI::REPLACE_CURRENT,
     *                 }
     *             ),
     *             @OA\Property(
