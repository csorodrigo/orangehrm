...
namespace CiaFerias\Tests\CorporateBranding\Service;

use CiaFerias\Config\Config;
use CiaFerias\CorporateBranding\Service\ThemeService;
use CiaFerias\Framework\Services;
use CiaFerias\Tests\CorporateBranding\Api\ThemeAPITest;
...
class ThemeServiceTest extends KernelTestCase
{
    protected function setUp(): void
    {
        $fixture = Config::get(Config::PLUGINS_DIR)
            . '/ciaFeriasCorporateBrandingPlugin/test/fixtures/ThemeService.yaml';
    ...
    public function testGetImage(): void
    {
        ...
        $this->assertEquals('cia-ferias-logo.png', $image->getFilename());
    }
