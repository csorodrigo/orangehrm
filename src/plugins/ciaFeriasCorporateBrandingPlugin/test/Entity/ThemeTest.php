...
namespace CiaFerias\Tests\CorporateBranding\Entity;
...
class ThemeTest extends EntityTestCase
{
    public function testEntity(): void
    {
        ...
        $this->assertEquals('cia-ferias-logo.png', $theme->getClientLogoFilename());
        ...
        $this->assertEquals('cia_ferias_banner.jpg', $theme->getClientBannerFilename());
        ...
        $this->assertEquals('cia_ferias_login.jpeg', $theme->getLoginBannerFilename());
