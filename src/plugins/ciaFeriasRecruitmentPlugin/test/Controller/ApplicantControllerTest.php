...
use CiaFerias\Recruitment\Controller\PublicController\ApplicantController;
...
use CiaFerias\Tests\Util\Mock\ArrayCsrfTokenStorage;
...
class ApplicantControllerTest extends KernelTestCase
{
    ...
    public function setUp(): void
    {
        $fixture = Config::get(Config::PLUGINS_DIR)
            . '/ciaFeriasRecruitmentPlugin/test/fixtures/ApplicantControllerTest.yaml';
