...
use CiaFerias\Recruitment\Controller\PublicController\VacancyListRestController;
use CiaFerias\Recruitment\Controller\PublicController\VacancyRestController;
...
class VacancyListRestControllerTest extends KernelTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        $fixture = Config::get(Config::PLUGINS_DIR)
            .'/ciaFeriasRecruitmentPlugin/test/fixtures/VacancyListRestController.yaml';
