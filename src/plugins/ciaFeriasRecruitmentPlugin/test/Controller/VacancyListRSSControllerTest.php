...
namespace CiaFerias\Tests\Recruitment\Controller;
...
use CiaFerias\Recruitment\Controller\PublicController\VacancyListRSSController;
...
class VacancyListRSSControllerTest extends KernelTestCase
{
    public static function setUpBeforeClass(): void
    {
        $fixture = Config::get(Config::PLUGINS_DIR)
            . '/ciaFeriasRecruitmentPlugin/test/fixtures/VacancyRSSFeed.yaml';
            ...
            ->willReturnMap(
                [
                    [
                        ...
                        'http://localhost/ciaFerias/cia-ferias/web/index.php/recruitmentApply/jobs.rss'
                    ],
                    [
                        'recruitment_view_vacancy_list',
                        'http://localhost/ciaFerias/cia-ferias/web/index.php/recruitmentApply/jobs.html'
                    ]
                ]
            );
