...
namespace CiaFerias\Tests\Recruitment\Dao;

use Exception;
use CiaFerias\Config\Config;
use CiaFerias\Entity\VacancyAttachment;
use CiaFerias\Recruitment\Dao\RecruitmentAttachmentDao;
...
class RecruitmentAttachmentDaoTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(
            Config::PLUGINS_DIR
        ) . '/ciaFeriasRecruitmentPlugin/test/fixtures/RecruitmentAttachmentDao.yaml';
