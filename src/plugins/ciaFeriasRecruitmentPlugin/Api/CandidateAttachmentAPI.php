...
use CiaFerias\Recruitment\Api\Model\CandidateAttachmentModel;
...
class CandidateAttachmentAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 type="string",
     *                 maxLength=CiaFerias\Recruitment\Api\CandidateAttachmentAPI::PARAM_RULE_CURRENT_ATTACHMENT_MAX_LENGTH
     *             ),
     *             @OA\Property(property="attachment", ref="#/components/schemas/Base64Attachment"),
     *         )
     *     ),
