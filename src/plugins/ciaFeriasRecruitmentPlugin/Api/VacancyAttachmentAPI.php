...
use CiaFerias\Recruitment\Api\Model\VacancyAttachmentModel;
...
class VacancyAttachmentAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="comment",
     *                 type="string",
     *                 maxLength=CiaFerias\Recruitment\Api\VacancyAttachmentAPI::PARAM_RULE_COMMENT_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="attachmentType",
     *                 type="integer",
     *                 maximum=CiaFerias\Recruitment\Api\VacancyAttachmentAPI::PARAM_RULE_ATTACHMENT_TYPE_MAX_LENGTH
     *             ),
