...
use CiaFerias\Recruitment\Api\Model\InterviewAttachmentModel;
use CiaFerias\Recruitment\Dto\InterviewAttachmentSearchFilterParams;
use CiaFerias\Recruitment\Dto\RecruitmentAttachment;
...
class InterviewAttachmentAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="comment",
     *                 type="string",
     *                 maxLength=CiaFerias\Recruitment\Api\InterviewAttachmentAPI::PARAM_RULE_COMMENT_MAX_LENGTH
     *             ),
     ...
     *                 type="string",
     *                 maxLength=CiaFerias\Recruitment\Api\InterviewAttachmentAPI::PARAM_RULE_CURRENT_ATTACHMENT_MAX_LENGTH
     *             ),
     *             @OA\Property(property="attachment", ref="#/components/schemas/Base64Attachment"),
     *             @OA\Property(
     *                 property="comment",
