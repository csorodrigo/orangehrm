...
use CiaFerias\Entity\Decorator\VacancyDecorator;
use Doctrine\ORM\Mapping as ORM;

/**
 * @method VacancyDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_job_vacancy")
 * @ORM\Entity
 *
 */
class Vacancy
{
    ...
    /**
     * @var JobTitle
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\JobTitle", inversedBy="vacancies", cascade={"persist", "remove"})
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="vacancies", cascade={"persist", "remove"})
