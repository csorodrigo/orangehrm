...
use CiaFerias\Entity\Decorator\CandidateDecorator;
use CiaFerias\Entity\Decorator\DecoratorTrait;

/**
 * @method CandidateDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_job_candidate")
 * @ORM\Entity
 *
 */
class Candidate
{
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="candidates", cascade={"persist"})
     ...
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\CandidateVacancy", mappedBy="candidate")
     */
    private iterable $candidateVacancy;

    /**
     * @var iterable|CandidateAttachment[]
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\CandidateAttachment", mappedBy="candidate")
     */
    private iterable $candidateAttachment;

    /**
     * @var iterable|CandidateHistory[]
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\CandidateHistory", mappedBy="candidate")
     */
