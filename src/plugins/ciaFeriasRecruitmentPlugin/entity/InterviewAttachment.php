...
use CiaFerias\Entity\Decorator\InterviewAttachmentDecorator;
use Doctrine\ORM\Mapping as ORM;

/**
 * @method InterviewAttachmentDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_job_interview_attachment")
 * @ORM\Entity
 */
class InterviewAttachment
{
    ...
    /**
     * @var Interview
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Interview", cascade={"persist", "remove"})
