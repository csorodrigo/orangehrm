...
use CiaFerias\Entity\Decorator\CandidateAttachmentDecorator;
use Doctrine\ORM\Mapping as ORM;

/**
 * @method CandidateAttachmentDecorator getDecorator()
 * @ORM\Table(name="cia_ferias_job_candidate_attachment")
 * @ORM\Entity
 */
class CandidateAttachment
{
    ...
    /**
     * @var Candidate
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Candidate", inversedBy="candidateAttachments", cascade={"persist", "remove"})
