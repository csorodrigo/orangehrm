...
use DateTime;
use CiaFerias\Entity\Decorator\CandidateVacancyDecorator;
use CiaFerias\Entity\Decorator\DecoratorTrait;
use Doctrine\ORM\Mapping as ORM;

/**
 * @method CandidateVacancyDecorator getDecorator()
 * @ORM\Table(name="cia_ferias_job_candidate_vacancy")
 * @ORM\Entity
 */
class CandidateVacancy
{
    ...
    /**
     * @var Candidate
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Candidate", inversedBy="candidateVacancy", cascade={"persist", "remove"})
