...
use CiaFerias\Entity\Decorator\CandidateHistoryDecorator;
use CiaFerias\Entity\Decorator\DecoratorTrait;

/**
 * @method CandidateHistoryDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_job_candidate_history")
 * @ORM\Entity
 */
class CandidateHistory
{
    ...
    /**
     * @var Candidate
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Candidate", cascade={"persist", "remove"})
    ...
    /**
     * @var Vacancy|null
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Vacancy", cascade={"persist", "remove"})
     ...
     * @var Interview|null
     *
     * @ORM\OneToOne(targetEntity="CiaFerias\Entity\Interview", cascade={"persist", "remove"})
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="candidates", cascade={"persist", "remove"})
