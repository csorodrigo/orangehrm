...
use CiaFerias\Entity\Decorator\InterviewDecorator;
use Doctrine\ORM\Mapping as ORM;

/**
 * @method InterviewDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_job_interview")
 * @ORM\Entity
 */
class Interview
{
     ...
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\CandidateVacancy", cascade={"persist", "remove"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="CiaFerias\Entity\Employee")
     * @ORM\JoinTable(name="cia_ferias_job_interview_interviewer",
