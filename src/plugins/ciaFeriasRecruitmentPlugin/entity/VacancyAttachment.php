...
use CiaFerias\Entity\Decorator\VacancyAttachmentDecorator;

/**
 * @method VacancyAttachmentDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_job_vacancy_attachment")
 * @ORM\Entity
 *
 */
class VacancyAttachment
{
    ...
    /**
     * @var Vacancy
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Vacancy", inversedBy="vacancies", cascade={"persist", "remove"})
