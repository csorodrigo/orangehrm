...
class ResetPasswordServiceTest extends KernelTestCase
{
    ...
    public function testGenerateEmailBody(): void
    {
        ...
        $replacements = [
            ...
            'samantha',
            'http://localhost/ciaFerias/cia-ferias/web/index.php/auth/resetPassword/resetCode/YWRtaW4jU0VQQVJBVE9SI-xpEY5IF4lNPp8bfWQzz2Q',
            'YWRtaW4jU0VQQVJBVE9SI-xpEY5IF4lNPp8bfWQzz2Q',
        ];
    ...
    public function testSendPasswordResetCodeEmail(): void
    {
        ...
        $urlGenerator->expects($this->once())
            ->method('generate')
            ->willReturn(
                'http://localhost/ciaFerias/cia-ferias/web/index.php/auth/resetPassword/resetCode/YWRtaW4jU0VQQVJBVE9SI6kK4PL4sB8AtJa2y5WNP-Y'
            );
        $this->createKernelWithMockServices(
