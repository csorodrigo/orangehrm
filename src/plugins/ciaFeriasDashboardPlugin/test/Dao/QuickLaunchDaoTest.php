...
namespace CiaFerias\Tests\Dashboard\Dao;

use CiaFerias\Config\Config;
use CiaFerias\Core\Service\ConfigService;
use CiaFerias\Dashboard\Dao\QuickLaunchDao;
...
class QuickLaunchDaoTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixtureDir = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasDashboardPlugin/test/fixtures';
