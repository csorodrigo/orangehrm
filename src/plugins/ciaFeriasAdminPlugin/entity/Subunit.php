...
use CiaFerias\ORM\NestedSet\NestedSetInterface;
use CiaFerias\ORM\NestedSet\NestedSetTrait;
use CiaFerias\ORM\NestedSet\Node;
use CiaFerias\ORM\NestedSet\NodeInterface;

/**
 * Subunit
 *
 * @ORM\Table(name="cia_ferias_subunit")
 * @ORM\Entity
 */
