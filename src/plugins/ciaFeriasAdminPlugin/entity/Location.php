...
use CiaFerias\Entity\Decorator\LocationDecorator;
use Doctrine\ORM\Mapping as ORM;

/**
 * @method LocationDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_location")
 * @ORM\Entity
 */
class Location
{
     ...
     * @var Country
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Country")
     ...
     * @var Employee[]
     *
     * @ORM\ManyToMany(targetEntity="CiaFerias\Entity\Employee", mappedBy="locations")
     */
