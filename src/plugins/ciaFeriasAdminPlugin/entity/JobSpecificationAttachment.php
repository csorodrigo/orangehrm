...
use CiaFerias\Entity\Decorator\JobSpecificationAttachmentDecorator;

/**
 * @method JobSpecificationAttachmentDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_job_specification_attachment")
 * @ORM\Entity
 */
class JobSpecificationAttachment
{
     ...
     * @var JobTitle
     *
     * @ORM\OneToOne(targetEntity="CiaFerias\Entity\JobTitle", inversedBy="jobSpecificationAttachment", cascade={"persist", "remove"})
