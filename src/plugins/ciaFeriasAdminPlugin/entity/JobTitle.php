...
/**
 * @ORM\Table(name="cia_ferias_job_title")
 * @ORM\Entity
 */
class JobTitle
{
     ...
     *
     * @ORM\OneToOne(targetEntity="CiaFerias\Entity\JobSpecificationAttachment", mappedBy="jobTitle", cascade={"persist", "remove"})
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\Employee", mappedBy="jobTitle")
     */
    private $employees;
