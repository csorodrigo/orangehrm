...
use Exception;
use CiaFerias\Admin\Api\Model\NationalityModel;
...
class NationalityAPI extends EndPoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=CiaFerias\Admin\Api\NationalityAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),
