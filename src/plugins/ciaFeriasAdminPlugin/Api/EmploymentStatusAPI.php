...
use CiaFerias\Admin\Api\Model\EmploymentStatusModel;
use CiaFerias\Admin\Dto\EmploymentStatusSearchFilterParams;
use CiaFerias\Admin\Service\EmploymentStatusService;
...
class EmploymentStatusAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=CiaFerias\Admin\Api\EmploymentStatusAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),
