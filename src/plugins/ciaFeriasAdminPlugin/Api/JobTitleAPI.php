...
use CiaFerias\Admin\Api\Model\JobTitleModel;
use CiaFerias\Admin\Dto\JobTitleSearchFilterParams;
...
use CiaFerias\Core\Dto\Base64Attachment;
...
class JobTitleAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="title", type="string", maxLength=CiaFerias\Admin\Api\JobTitleAPI::PARAM_RULE_TITLE_MAX_LENGTH),
     *             @OA\Property(property="description", type="string", default=null, maxLength=CiaFerias\Admin\Api\JobTitleAPI::PARAM_RULE_DESCRIPTION_MAX_LENGTH),
     *             @OA\Property(property="note", type="string", default=null, maxLength=CiaFerias\Admin\Api\JobTitleAPI::PARAM_RULE_NOTE_MAX_LENGTH),
     ...
     *             @OA\Property(property="description", type="string", default=null, maxLength=CiaFerias\Admin\Api\JobTitleAPI::PARAM_RULE_DESCRIPTION_MAX_LENGTH),
     *             @OA\Property(property="note", type="string", default=null, maxLength=CiaFerias\Admin\Api\JobTitleAPI::PARAM_RULE_NOTE_MAX_LENGTH),
     *             @OA\Property(property="currentJobSpecification", type="string", enum=CiaFerias\Admin\Api\JobTitleAPI::CURRENT_JOB_SPECIFICATION, default=null),
     *             @OA\Property(property="specification", ref="#/components/schemas/Base64AttachmentOrNull"),
     *             required={"title"}
     *         )
     *     ),
