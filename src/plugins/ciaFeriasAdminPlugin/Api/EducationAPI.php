...
use Exception;
use CiaFerias\Admin\Api\Model\EducationModel;
use CiaFerias\Admin\Dto\QualificationEducationSearchFilterParams;
use CiaFerias\Admin\Service\EducationService;
...
class EducationAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=CiaFerias\Admin\Api\EducationAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),
