...
use Exception;
use CiaFerias\Admin\Api\Model\SkillModel;
use CiaFerias\Admin\Dto\SkillSearchFilterParams;
use CiaFerias\Admin\Service\SkillService;
...
class SkillAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=CiaFerias\Admin\Api\SkillAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             @OA\Property(property="description", type="string, maxLength=CiaFerias\Admin\Api\SkillAPI::PARAM_RULE_DESCRIPTION_MAX_LENGTH"),
     *             required={"name"}
     *         )
     *     ),
