...
use CiaFerias\Admin\Api\Model\UserModel;
use CiaFerias\Admin\Api\ValidationRules\UserRoleIdAssignableRule;
...
class UserAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="username",
     *                 type="string",
     *                 minLength=CiaFerias\Admin\Api\UserAPI::PARAM_RULE_USERNAME_MIN_LENGTH,
     *                 maxLength=CiaFerias\Admin\Api\UserAPI::PARAM_RULE_USERNAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="password",
     *                 type="string",
     *                 maxLength=CiaFerias\Admin\Api\UserAPI::PARAM_RULE_PASSWORD_MAX_LENGTH
     *             ),
