...
class I18NTranslationValidationAPI extends Endpoint implements ResourceEndpoint
{
     ...
     *         in="query",
     *         required=true,
     *         @OA\Schema(type="string", maxLength=CiaFerias\Admin\Api\I18NTranslationValidationAPI::PARAM_RULE_TRANSLATION_MAX_LENGTH)
     *     ),
     *     @OA\Response(
     *         response="200",
     *         description="Success",
     ...
     *                 @OA\Property(property="code", type="string", nullable=true, enum=CiaFerias\Entity\I18NError::ERROR_MAP),
