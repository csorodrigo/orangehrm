...
use CiaFerias\Admin\Api\Model\JobCategoryModel;
use CiaFerias\Admin\Service\JobCategoryService;
...
use CiaFerias\Entity\JobCategory;
...
class JobCategoryAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=CiaFerias\Admin\Api\JobCategoryAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),
