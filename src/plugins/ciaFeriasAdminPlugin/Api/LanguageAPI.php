...
use Exception;
use CiaFerias\Admin\Api\Model\LanguageModel;
use CiaFerias\Admin\Dto\LanguageSearchFilterParams;
use CiaFerias\Admin\Service\LanguageService;
...
class LanguageAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=CiaFerias\Admin\Api\LanguageAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),
