...
use Exception;
use CiaFerias\Admin\Api\Model\MembershipModel;
use CiaFerias\Admin\Dto\MembershipSearchFilterParams;
use CiaFerias\Admin\Service\MembershipService;
...
class MembershipAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=CiaFerias\Admin\Api\MembershipAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),
