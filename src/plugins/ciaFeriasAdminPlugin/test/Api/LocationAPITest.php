...
use CiaFerias\Admin\Api\LocationAPI;
...
class LocationAPITest extends EndpointTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        TestDataService::populate(
            Config::get(Config::PLUGINS_DIR) . '/ciaFeriasAdminPlugin/test/fixtures/LocationDao.yml'
        );
    ...
    protected function getTestCasesByKey($testCaseKey): array
    {
        return TestDataService::loadFixtures(
            Config::get(Config::PLUGINS_DIR) . '/ciaFeriasAdminPlugin/test/fixtures/testcases/LocationAPI.yml',
            $testCaseKey
        );
    }
