...
use CiaFerias\Admin\Dao\CompanyStructureDao;
use CiaFerias\Admin\Dao\OrganizationDao;
...
class OrganizationDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasAdminPlugin/test/fixtures/OrganizationDao.yml';
    ...
    public function testSaveOrganizationGeneralInformation(): void
    {
        ...
        $organization->setName("cia-ferias");
        ...
        $organization->setEmail('test@cia-ferias.local');
        ...
        $this->assertEquals("cia-ferias", $result->getName());
        $this->assertEquals("1234", $result->getTaxId());

        $updatedSubunit = $this->companyStructureDao->getSubunitById(1);
        $this->assertEquals('cia-ferias', $updatedSubunit->getName());
    }
}
