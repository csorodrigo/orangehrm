...
use Exception;
use CiaFerias\Admin\Dao\EmailSubscriberDao;
use CiaFerias\Admin\Dto\EmailSubscriberSearchFilterParams;
use CiaFerias\Config\Config;
use CiaFerias\Entity\EmailSubscriber;
...
class EmailSubscriberDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasAdminPlugin/test/fixtures/EmailSubscriptionDao.yaml';
    ...
    public function testGetEmailSubscriberById(): void
    {
        ...
        $this->assertEquals('rajitha@cia-ferias.local', $emailSubscriber->getEmail());
    ...
    public function testSaveEmailSubscriber(): void
    {
        ...
        $emailSubscriber->setEmail("kavi@cia-ferias.local");
        ...
        $this->assertEquals('kavi@cia-ferias.local', $emailSubscriber->getEmail());
        $this->assertEquals('Leave Applications', $emailSubscriber->getEmailNotification()->getName());
    }
    ...
    public function testEditEmailSubscriber(): void
    {
        ...
        $emailSubscriber->setEmail("rajitha@cia-ferias.local");
        $emailSubscriber->setEmailNotification($emailSubscription);
        $result = $this->emailSubscriberDao->saveEmailSubscriber($emailSubscriber);
