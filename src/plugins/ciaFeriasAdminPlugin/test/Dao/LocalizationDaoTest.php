...
class LocalizationDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasAdminPlugin/test/fixtures/LocalizationDao.yml';
    ...
    public function getTestCases($key)
    {
        $testCases = Yaml::parseFile(
            ...
            '/ciaFeriasAdminPlugin/test/testCases/I18NDaoTestCases.yml'
        );
