...
class CompanyStructureDaoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) .
            '/ciaFeriasAdminPlugin/test/fixtures/CompanyStructureDao.yml';
        TestDataService::populate($this->fixture);
    }

    public function testSetOrganizationName(): void
    {
        $this->assertEquals($this->companyStructureDao->setOrganizationName("cia-ferias"), 1);
    }
    ...
    public function testSaveSubunit(): void
    {
        ...
        $subunit->setDescription("Handles cia-ferias product");
