...
namespace CiaFerias\Tests\OAuth\Service;

use CiaFerias\Config\Config;
use CiaFerias\Core\Dao\ModuleDao;
...
class ModuleServiceTest extends TestCase
{
    ...
    {
        $expectedModuleList = TestDataService::loadObjectList('Module', Config::get(Config::PLUGINS_DIR) . '/ciaFeriasAdminPlugin/test/fixtures/ModuleDao.yml', 'Module');
