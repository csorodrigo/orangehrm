...
use DateTime;
use Exception;
use CiaFerias\Admin\Controller\File\LanguagePackage;
use CiaFerias\Admin\Dao\LocalizationDao;
use CiaFerias\Admin\Dto\I18NGroupSearchFilterParams;
use CiaFerias\Admin\Dto\I18NImportErrorSearchFilterParams;
use CiaFerias\Admin\Dto\I18NLanguageSearchFilterParams;
use CiaFerias\Admin\Exception\XliffFileProcessFailedException;
use CiaFerias\Admin\Service\LocalizationService;
...
use CiaFerias\Entity\I18NImportError;
...
class LocalizationServiceTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $fixture = Config::get(Config::PLUGINS_DIR)
            . '/ciaFeriasAdminPlugin/test/fixtures/I18NTranslationExport.yml';
