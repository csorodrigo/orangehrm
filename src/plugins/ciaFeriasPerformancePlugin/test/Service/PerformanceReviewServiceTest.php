...
namespace CiaFerias\Tests\Performance\Service;

use CiaFerias\Config\Config;
use CiaFerias\Entity\PerformanceReview;
use CiaFerias\Framework\Services;
use CiaFerias\Performance\Dao\PerformanceReviewDao;
use CiaFerias\Performance\Exception\ReviewServiceException;
use CiaFerias\Performance\Service\PerformanceReviewService;
...
class PerformanceReviewServiceTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasPerformancePlugin/test/fixtures/PerformanceReviewService.yaml';
