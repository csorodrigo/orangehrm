...
use CiaFerias\Performance\Exception\KpiServiceException;
use CiaFerias\Performance\Service\KpiService;
...
class KpiServiceTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR) . '/ciaFeriasPerformancePlugin/test/fixtures/KpiService.yaml';
