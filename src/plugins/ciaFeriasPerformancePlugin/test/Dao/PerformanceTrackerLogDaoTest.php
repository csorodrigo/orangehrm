...
use CiaFerias\Performance\Dao\PerformanceTrackerLogDao;
use CiaFerias\Performance\Dto\PerformanceTrackerLogSearchFilterParams;
...
class PerformanceTrackerLogDaoTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixture = Config::get(Config::PLUGINS_DIR).'/ciaFeriasPerformancePlugin/test/fixtures/PerformanceTrackerLogDao.yaml';
