...
use CiaFerias\Entity\Decorator\PerformanceReviewDecorator;

/**
 * @method PerformanceReviewDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_performance_review")
 * @ORM\Entity
 */
class PerformanceReview
{
     ...
     * @var ReviewerRating[]
     *
     * @ORM\ManyToMany(targetEntity="CiaFerias\Entity\ReviewerRating", mappedBy="PerformanceReview")
     * @ORM\JoinColumns({
     ...
     * @var Reviewer[]
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\Reviewer", mappedBy="review")
     */
     ...
     * @var JobTitle|null
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\JobTitle", inversedBy="PerformanceReview")
     * @ORM\JoinColumns({
     ...
     * @var Subunit|null
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Subunit", inversedBy="PerformanceReview")
     * @ORM\JoinColumns({
     ...
     * @var Employee|null
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="PerformanceReview")
     * @ORM\JoinColumns({
