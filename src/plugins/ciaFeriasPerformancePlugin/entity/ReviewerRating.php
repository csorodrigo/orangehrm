...
use CiaFerias\Entity\Decorator\ReviewerRatingDecorator;

/**
 * @method ReviewerRatingDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_reviewer_rating")
 * @ORM\Entity
 */
class ReviewerRating
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\PerformanceReview", inversedBy="ReviewerRating")
     * @ORM\JoinColumns({
     ...
     * @var Reviewer
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Reviewer", inversedBy="ReviewerRating")
     * @ORM\JoinColumns({
     ...
     * @var Kpi|null
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Kpi", inversedBy="ReviewerRating")
     * @ORM\JoinColumns({
