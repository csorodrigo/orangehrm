...
use CiaFerias\Entity\Decorator\PerformanceTrackerLogDecorator;

/**
 * @method PerformanceTrackerLogDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_performance_tracker_log")
 * @ORM\Entity
 */
class PerformanceTrackerLog
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\PerformanceTracker")
