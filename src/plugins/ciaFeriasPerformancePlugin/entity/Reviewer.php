...
use CiaFerias\Entity\Decorator\ReviewerDecorator;

/**
 * @method ReviewerDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_reviewer")
 * @ORM\Entity
 */
class Reviewer
{
     ...
     * @var ReviewerRating[]
     *
     * @ORM\ManyToMany(targetEntity="CiaFerias\Entity\ReviewerRating", mappedBy="Reviewer")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\ReviewerGroup", inversedBy="Reviewer")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\PerformanceReview", inversedBy="Reviewer")
     * @ORM\JoinColumns({
     ...
     * @var Employee|null
     *
     * @ORM\ManyToOne(targetEntity="CiaFerias\Entity\Employee", inversedBy="Reviewer")
     * @ORM\JoinColumns({
