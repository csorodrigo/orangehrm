...
use CiaFerias\Entity\Decorator\PerformanceTrackerDecorator;

/**
 * @method PerformanceTrackerDecorator getDecorator()
 *
 * @ORM\Table(name="cia_ferias_performance_track")
 * @ORM\Entity
 */
class PerformanceTracker
{
     ...
     *
     * @ORM\OneToMany(targetEntity="CiaFerias\Entity\PerformanceTrackerReviewer", mappedBy="performanceTracker")
     */
