...
namespace CiaFerias\Installer\Migration\V5_8_1;
...
class Migration extends AbstractMigration
{
    ...
    public function up(): void
    {
        ...
        $this->getSchemaHelper()->changeColumn('cia_ferias_email_configuration', 'smtp_password', $string512);
        $this->getSchemaHelper()->changeColumn('cia_ferias_auth_provider_extra_details', 'client_secret', $string512);
    }
